...
00000000000001c6 <main>:
{
 ...
 22a:	8aa58593          	addi	a1,a1,-1878 # ad0 <malloc+0xea>
 22e:	4509                	li	a0,2
 230:	6d2000ef          	jal	ra,902 <fprintf>
    exit(1);
 234:	4505                	li	a0,1
 ...
 250:	8a450513          	addi	a0,a0,-1884 # af0 <malloc+0x10a>
 254:	6d8000ef          	jal	ra,92c <printf>
      exit(1);
 258:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5d6:	0805c663          	bltz	a1,662 <printint+0x9e>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 5ea:	52a50513          	addi	a0,a0,1322 # b10 <digits>
 5ee:	883a                	mv	a6,a4
 ...
 620:	fef70423          	sb	a5,-24(a4)
 624:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
 628:	02e05663          	blez	a4,654 <printint+0x90>
 62c:	fb840793          	addi	a5,s0,-72
 ...
 648:	8526                	mv	a0,s1
 64a:	f5dff0ef          	jal	ra,5a6 <putc>
  while(--i >= 0)
 64e:	197d                	addi	s2,s2,-1
 650:	ff391ae3          	bne	s2,s3,644 <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 68c:	24090c63          	beqz	s2,8e4 <vprintf+0x27a>
 690:	8b2a                	mv	s6,a0
 692:	8a2e                	mv	s4,a1
 694:	8bb2                	mv	s7,a2
  state = 0;
 ...
 6a8:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 6ac:	00000c97          	auipc	s9,0x0
 6b0:	464c8c93          	addi	s9,s9,1124 # b10 <digits>
 6b4:	a005                	j	6d4 <vprintf+0x6a>
        putc(fd, c0);
 6b6:	85ca                	mv	a1,s2
 6b8:	855a                	mv	a0,s6
 6ba:	eedff0ef          	jal	ra,5a6 <putc>
 6be:	a019                	j	6c4 <vprintf+0x5a>
    } else if(state == '%'){
 6c0:	03598263          	beq	s3,s5,6e4 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 6c4:	2485                	addiw	s1,s1,1
 6c6:	8726                	mv	a4,s1
 6c8:	009a07b3          	add	a5,s4,s1
 6cc:	0007c903          	lbu	s2,0(a5)
 6d0:	20090a63          	beqz	s2,8e4 <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
 6d4:	0009079b          	sext.w	a5,s2
    if(state == 0){
 6d8:	fe0994e3          	bnez	s3,6c0 <vprintf+0x56>
      if(c0 == '%'){
 6dc:	fd579de3          	bne	a5,s5,6b6 <vprintf+0x4c>
        state = '%';
 6e0:	89be                	mv	s3,a5
 6e2:	b7cd                	j	6c4 <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 6e4:	c3c1                	beqz	a5,764 <vprintf+0xfa>
 6e6:	00ea06b3          	add	a3,s4,a4
 6ea:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
 6ee:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 6f0:	c681                	beqz	a3,6f8 <vprintf+0x8e>
 6f2:	9752                	add	a4,a4,s4
 6f4:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 6f8:	03878e63          	beq	a5,s8,734 <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
 6fc:	05a78863          	beq	a5,s10,74c <vprintf+0xe2>
      } else if(c0 == 'u'){
 700:	0db78b63          	beq	a5,s11,7d6 <vprintf+0x16c>
 ...
 708:	10e78d63          	beq	a5,a4,822 <vprintf+0x1b8>
 ...
 710:	14e78263          	beq	a5,a4,854 <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 714:	06300713          	li	a4,99
 718:	16e78f63          	beq	a5,a4,896 <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 71c:	07300713          	li	a4,115
 720:	18e78563          	beq	a5,a4,8aa <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 724:	05579063          	bne	a5,s5,764 <vprintf+0xfa>
        putc(fd, '%');
 728:	85d6                	mv	a1,s5
 72a:	855a                	mv	a0,s6
 72c:	e7bff0ef          	jal	ra,5a6 <putc>
 ...
 740:	855a                	mv	a0,s6
 742:	e83ff0ef          	jal	ra,5c4 <printint>
 746:	8bca                	mv	s7,s2
      state = 0;
 748:	4981                	li	s3,0
 74a:	bfad                	j	6c4 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 74c:	03868663          	beq	a3,s8,778 <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 750:	05a68163          	beq	a3,s10,792 <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
 754:	09b68d63          	beq	a3,s11,7ee <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 758:	03a68f63          	beq	a3,s10,796 <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
 75c:	07800793          	li	a5,120
 760:	0cf68d63          	beq	a3,a5,83a <vprintf+0x1d0>
        putc(fd, '%');
 764:	85d6                	mv	a1,s5
 766:	855a                	mv	a0,s6
 768:	e3fff0ef          	jal	ra,5a6 <putc>
        putc(fd, c0);
 76c:	85ca                	mv	a1,s2
 76e:	855a                	mv	a0,s6
 770:	e37ff0ef          	jal	ra,5a6 <putc>
      state = 0;
 774:	4981                	li	s3,0
 776:	b7b9                	j	6c4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 784:	855a                	mv	a0,s6
 786:	e3fff0ef          	jal	ra,5c4 <printint>
        i += 1;
 ...
 78e:	4981                	li	s3,0
        i += 1;
 790:	bf15                	j	6c4 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 792:	03860563          	beq	a2,s8,7bc <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 796:	07b60963          	beq	a2,s11,808 <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 79a:	07800793          	li	a5,120
 79e:	fcf613e3          	bne	a2,a5,764 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 7ae:	855a                	mv	a0,s6
 7b0:	e15ff0ef          	jal	ra,5c4 <printint>
        i += 2;
 ...
 7c8:	855a                	mv	a0,s6
 7ca:	dfbff0ef          	jal	ra,5c4 <printint>
        i += 2;
 ...
 7e2:	855a                	mv	a0,s6
 7e4:	de1ff0ef          	jal	ra,5c4 <printint>
 7e8:	8bca                	mv	s7,s2
      state = 0;
 7ea:	4981                	li	s3,0
 7ec:	bde1                	j	6c4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 7fa:	855a                	mv	a0,s6
 7fc:	dc9ff0ef          	jal	ra,5c4 <printint>
        i += 1;
 ...
 814:	855a                	mv	a0,s6
 816:	dafff0ef          	jal	ra,5c4 <printint>
        i += 2;
 ...
 82e:	855a                	mv	a0,s6
 830:	d95ff0ef          	jal	ra,5c4 <printint>
 834:	8bca                	mv	s7,s2
      state = 0;
 836:	4981                	li	s3,0
 838:	b571                	j	6c4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 846:	855a                	mv	a0,s6
 848:	d7dff0ef          	jal	ra,5c4 <printint>
        i += 1;
 ...
 850:	4981                	li	s3,0
        i += 1;
 852:	bd8d                	j	6c4 <vprintf+0x5a>
        printptr(fd, va_arg(ap, uint64));
 854:	008b8793          	addi	a5,s7,8
 858:	f8f43423          	sd	a5,-120(s0)
 ...
 880:	855a                	mv	a0,s6
 882:	d25ff0ef          	jal	ra,5a6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 886:	0992                	slli	s3,s3,0x4
 888:	397d                	addiw	s2,s2,-1
 88a:	fe0916e3          	bnez	s2,876 <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
 88e:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 892:	4981                	li	s3,0
 894:	bd05                	j	6c4 <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
 896:	008b8913          	addi	s2,s7,8
 89a:	000bc583          	lbu	a1,0(s7)
 89e:	855a                	mv	a0,s6
 8a0:	d07ff0ef          	jal	ra,5a6 <putc>
 8a4:	8bca                	mv	s7,s2
      state = 0;
 8a6:	4981                	li	s3,0
 8a8:	bd31                	j	6c4 <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 8aa:	008b8993          	addi	s3,s7,8
 8ae:	000bb903          	ld	s2,0(s7)
 8b2:	00090f63          	beqz	s2,8d0 <vprintf+0x266>
        for(; *s; s++)
 8b6:	00094583          	lbu	a1,0(s2)
 8ba:	c195                	beqz	a1,8de <vprintf+0x274>
          putc(fd, *s);
 8bc:	855a                	mv	a0,s6
 8be:	ce9ff0ef          	jal	ra,5a6 <putc>
        for(; *s; s++)
 8c2:	0905                	addi	s2,s2,1
 8c4:	00094583          	lbu	a1,0(s2)
 8c8:	f9f5                	bnez	a1,8bc <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 8ca:	8bce                	mv	s7,s3
      state = 0;
 8cc:	4981                	li	s3,0
 8ce:	bbdd                	j	6c4 <vprintf+0x5a>
          s = "(null)";
 8d0:	00000917          	auipc	s2,0x0
 8d4:	23890913          	addi	s2,s2,568 # b08 <malloc+0x122>
        for(; *s; s++)
 8d8:	02800593          	li	a1,40
 8dc:	b7c5                	j	8bc <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 8de:	8bce                	mv	s7,s3
      state = 0;
 8e0:	4981                	li	s3,0
 8e2:	b3cd                	j	6c4 <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 91a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 91e:	8622                	mv	a2,s0
 920:	d4bff0ef          	jal	ra,66a <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 94e:	85aa                	mv	a1,a0
 950:	4505                	li	a0,1
 952:	d19ff0ef          	jal	ra,66a <vprintf>
}
...
malloc(uint nbytes)
{
 ...
 a36:	5ce90913          	addi	s2,s2,1486 # 1000 <freep>
  if(p == SBRK_ERROR)
 a3a:	5afd                	li	s5,-1
 a3c:	a0bd                	j	aaa <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
 a3e:	00001797          	auipc	a5,0x1
 a42:	9d278793          	addi	a5,a5,-1582 # 1410 <base>
 ...
 a98:	ec7ff0ef          	jal	ra,95e <free>
  return freep;
 a9c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 aa0:	dd61                	beqz	a0,a78 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 aa2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 aa4:	4798                	lw	a4,8(a5)
 aa6:	fa9778e3          	bgeu	a4,s1,a56 <malloc+0x70>
    if(p == freep)
 aaa:	00093703          	ld	a4,0(s2)
 aae:	853e                	mv	a0,a5
 ab0:	fef719e3          	bne	a4,a5,aa2 <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
 ab4:	8552                	mv	a0,s4
 ab6:	a15ff0ef          	jal	ra,4ca <sbrk>
  if(p == SBRK_ERROR)
 aba:	fd551ce3          	bne	a0,s5,a92 <malloc+0xac>
        return 0;
 abe:	4501                	li	a0,0
 ac0:	bf65                	j	a78 <malloc+0x92>
