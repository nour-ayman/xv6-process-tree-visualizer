...
cat(int fd)
{
  ...
  3c:	91858593          	addi	a1,a1,-1768 # 950 <malloc+0xea>
  40:	4509                	li	a0,2
  42:	740000ef          	jal	ra,782 <fprintf>
      exit(1);
  46:	4505                	li	a0,1
  ...
  62:	90a58593          	addi	a1,a1,-1782 # 968 <malloc+0x102>
  66:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  d6:	8ae58593          	addi	a1,a1,-1874 # 980 <malloc+0x11a>
  da:	4509                	li	a0,2
  dc:	6a6000ef          	jal	ra,782 <fprintf>
      exit(1);
  e0:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 46a:	53a50513          	addi	a0,a0,1338 # 9a0 <digits>
 46e:	883a                	mv	a6,a4
