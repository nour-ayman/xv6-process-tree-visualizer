...
main(int argc, char *argv[])
{
  ...
  14:	8a058593          	addi	a1,a1,-1888 # 8b0 <malloc+0xe4>
  18:	4509                	li	a0,2
  1a:	6ce000ef          	jal	ra,6e8 <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  20:	2cc000ef          	jal	ra,2ec <exit>
  24:	84ae                	mv	s1,a1
  }
  if(link(argv[1], argv[2]) < 0)
  26:	698c                	ld	a1,16(a1)
  28:	6488                	ld	a0,8(s1)
  2a:	322000ef          	jal	ra,34c <link>
  2e:	00054563          	bltz	a0,38 <main+0x38>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
  32:	4501                	li	a0,0
  34:	2b8000ef          	jal	ra,2ec <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  38:	6894                	ld	a3,16(s1)
  3a:	6490                	ld	a2,8(s1)
  3c:	00001597          	auipc	a1,0x1
  40:	88c58593          	addi	a1,a1,-1908 # 8c8 <malloc+0xfc>
  44:	4509                	li	a0,2
...
stat(const char *n, struct stat *st)
{
 ...
 1a2:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1a4:	85ca                	mv	a1,s2
 1a6:	19e000ef          	jal	ra,344 <fstat>
 1aa:	892a                	mv	s2,a0
  close(fd);
 1ac:	8526                	mv	a0,s1
 1ae:	166000ef          	jal	ra,314 <close>
  return r;
}
 1b2:	854a                	mv	a0,s2
...
sbrk(int n) {
 ...
 2c0:	4585                	li	a1,1
 2c2:	0b2000ef          	jal	ra,374 <sys_sbrk>
}
 2c6:	60a2                	ld	ra,8(sp)
 2c8:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 2d6:	4589                	li	a1,2
 2d8:	09c000ef          	jal	ra,374 <sys_sbrk>
}
 2dc:	60a2                	ld	ra,8(sp)
 2de:	6402                	ld	s0,0(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 496:	456c8c93          	addi	s9,s9,1110 # 8e8 <digits>
 ...
 526:	855a                	mv	a0,s6
 528:	e83ff0ef          	jal	ra,3aa <printint>
 52c:	8bca                	mv	s7,s2
      state = 0;
 52e:	4981                	li	s3,0
 ...
 56a:	855a                	mv	a0,s6
 56c:	e3fff0ef          	jal	ra,3aa <printint>
        i += 1;
 ...
 594:	855a                	mv	a0,s6
 596:	e15ff0ef          	jal	ra,3aa <printint>
        i += 2;
 ...
 5ae:	855a                	mv	a0,s6
 5b0:	dfbff0ef          	jal	ra,3aa <printint>
        i += 2;
 ...
 5c8:	855a                	mv	a0,s6
 5ca:	de1ff0ef          	jal	ra,3aa <printint>
 5ce:	8bca                	mv	s7,s2
      state = 0;
 5d0:	4981                	li	s3,0
 ...
 5e0:	855a                	mv	a0,s6
 5e2:	dc9ff0ef          	jal	ra,3aa <printint>
        i += 1;
 ...
 5fa:	855a                	mv	a0,s6
 5fc:	dafff0ef          	jal	ra,3aa <printint>
        i += 2;
 ...
 614:	855a                	mv	a0,s6
 616:	d95ff0ef          	jal	ra,3aa <printint>
 61a:	8bca                	mv	s7,s2
      state = 0;
 61c:	4981                	li	s3,0
 ...
 62c:	855a                	mv	a0,s6
 62e:	d7dff0ef          	jal	ra,3aa <printint>
        i += 1;
 ...
 6ba:	22a90913          	addi	s2,s2,554 # 8e0 <malloc+0x114>
        for(; *s; s++)
