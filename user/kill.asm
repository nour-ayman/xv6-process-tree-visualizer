...
main(int argc, char **argv)
{
  ...
  2c:	2f4000ef          	jal	ra,320 <kill>
  for(i=1; i<argc; i++)
  30:	04a1                	addi	s1,s1,8
  32:	ff249ae3          	bne	s1,s2,26 <main+0x26>
  exit(0);
  36:	4501                	li	a0,0
  38:	2b8000ef          	jal	ra,2f0 <exit>
    fprintf(2, "usage: kill pid...\n");
  3c:	00001597          	auipc	a1,0x1
  40:	88458593          	addi	a1,a1,-1916 # 8c0 <malloc+0xe8>
  44:	4509                	li	a0,2
  46:	6ae000ef          	jal	ra,6f4 <fprintf>
    exit(1);
  4a:	4505                	li	a0,1
  4c:	2a4000ef          	jal	ra,2f0 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 1a6:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1a8:	85ca                	mv	a1,s2
 1aa:	19e000ef          	jal	ra,348 <fstat>
 1ae:	892a                	mv	s2,a0
  close(fd);
 1b0:	8526                	mv	a0,s1
 1b2:	166000ef          	jal	ra,318 <close>
  return r;
}
 1b6:	854a                	mv	a0,s2
...
sbrk(int n) {
 ...
 2c4:	4585                	li	a1,1
 2c6:	0b2000ef          	jal	ra,378 <sys_sbrk>
}
 2ca:	60a2                	ld	ra,8(sp)
 2cc:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 2da:	4589                	li	a1,2
 2dc:	09c000ef          	jal	ra,378 <sys_sbrk>
}
 2e0:	60a2                	ld	ra,8(sp)
 2e2:	6402                	ld	s0,0(sp)
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3c8:	0805c663          	bltz	a1,454 <printint+0x9e>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 3dc:	50850513          	addi	a0,a0,1288 # 8e0 <digits>
 3e0:	883a                	mv	a6,a4
 ...
 416:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 41a:	02e05663          	blez	a4,446 <printint+0x90>
 ...
 43a:	8526                	mv	a0,s1
 43c:	f5dff0ef          	jal	ra,398 <putc>
  while(--i >= 0)
 440:	197d                	addi	s2,s2,-1
 442:	ff391ae3          	bne	s2,s3,436 <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	442c8c93          	addi	s9,s9,1090 # 8e0 <digits>
 4a6:	a005                	j	4c6 <vprintf+0x6a>
        putc(fd, c0);
 4a8:	85ca                	mv	a1,s2
 4aa:	855a                	mv	a0,s6
 4ac:	eedff0ef          	jal	ra,398 <putc>
 ...
 532:	855a                	mv	a0,s6
 534:	e83ff0ef          	jal	ra,3b6 <printint>
 538:	8bca                	mv	s7,s2
      state = 0;
 53a:	4981                	li	s3,0
 ...
 556:	85d6                	mv	a1,s5
 558:	855a                	mv	a0,s6
 55a:	e3fff0ef          	jal	ra,398 <putc>
        putc(fd, c0);
 55e:	85ca                	mv	a1,s2
 560:	855a                	mv	a0,s6
 562:	e37ff0ef          	jal	ra,398 <putc>
      state = 0;
 566:	4981                	li	s3,0
 ...
 576:	855a                	mv	a0,s6
 578:	e3fff0ef          	jal	ra,3b6 <printint>
        i += 1;
 ...
 5a0:	855a                	mv	a0,s6
 5a2:	e15ff0ef          	jal	ra,3b6 <printint>
        i += 2;
 ...
 5ba:	855a                	mv	a0,s6
 5bc:	dfbff0ef          	jal	ra,3b6 <printint>
        i += 2;
 ...
 5d4:	855a                	mv	a0,s6
 5d6:	de1ff0ef          	jal	ra,3b6 <printint>
 5da:	8bca                	mv	s7,s2
      state = 0;
 5dc:	4981                	li	s3,0
 ...
 5ec:	855a                	mv	a0,s6
 5ee:	dc9ff0ef          	jal	ra,3b6 <printint>
        i += 1;
 ...
 606:	855a                	mv	a0,s6
 608:	dafff0ef          	jal	ra,3b6 <printint>
        i += 2;
 ...
 620:	855a                	mv	a0,s6
 622:	d95ff0ef          	jal	ra,3b6 <printint>
 626:	8bca                	mv	s7,s2
      state = 0;
 628:	4981                	li	s3,0
 ...
 638:	855a                	mv	a0,s6
 63a:	d7dff0ef          	jal	ra,3b6 <printint>
        i += 1;
 ...
 6c6:	21690913          	addi	s2,s2,534 # 8d8 <malloc+0x100>
        for(; *s; s++)
