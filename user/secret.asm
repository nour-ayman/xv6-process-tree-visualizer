...
main(int argc, char *argv[])
{
  ...
  if(argc != 2){
   a:	4789                	li	a5,2
   c:	00f50b63          	beq	a0,a5,22 <main+0x22>
    printf("Usage: secret the-secret\n");
  10:	00001517          	auipc	a0,0x1
  14:	8a050513          	addi	a0,a0,-1888 # 8b0 <malloc+0xe4>
  18:	6fa000ef          	jal	ra,712 <printf>
    exit(1);
  1c:	4505                	li	a0,1
  1e:	2ce000ef          	jal	ra,2ec <exit>
  22:	84ae                	mv	s1,a1
  }

  strcpy(data, "This may help.");
  24:	00001597          	auipc	a1,0x1
  28:	8ac58593          	addi	a1,a1,-1876 # 8d0 <malloc+0x104>
  2c:	00001517          	auipc	a0,0x1
  30:	fe450513          	addi	a0,a0,-28 # 1010 <data>
  34:	02a000ef          	jal	ra,5e <strcpy>

  strcpy(data + 16, argv[1]);
  38:	648c                	ld	a1,8(s1)
  3a:	00001517          	auipc	a0,0x1
  3e:	fe650513          	addi	a0,a0,-26 # 1020 <data+0x10>
  42:	01c000ef          	jal	ra,5e <strcpy>

  exit(0);
  46:	4501                	li	a0,0
  48:	2a4000ef          	jal	ra,2ec <exit>
...
malloc(uint nbytes)
{
 ...
 822:	a0bd                	j	890 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
 824:	00008797          	auipc	a5,0x8
 828:	7ec78793          	addi	a5,a5,2028 # 9010 <base>
