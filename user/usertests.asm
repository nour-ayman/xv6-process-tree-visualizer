...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	69278793          	addi	a5,a5,1682 # 76a0 <malloc+0x2564>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	1da50513          	addi	a0,a0,474 # 5240 <malloc+0x104>
      6e:	014050ef          	jal	ra,5082 <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	1c050513          	addi	a0,a0,448 # 5260 <malloc+0x124>
      a8:	7db040ef          	jal	ra,5082 <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	1b850513          	addi	a0,a0,440 # 5278 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	1c250513          	addi	a0,a0,450 # 5298 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	18e50513          	addi	a0,a0,398 # 5280 <malloc+0x144>
      fa:	789040ef          	jal	ra,5082 <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	1a250513          	addi	a0,a0,418 # 52a8 <malloc+0x16c>
     10e:	775040ef          	jal	ra,5082 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	15450513          	addi	a0,a0,340 # 52d0 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	14a50513          	addi	a0,a0,330 # 52f0 <malloc+0x1b4>
     1ae:	6d5040ef          	jal	ra,5082 <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	06650513          	addi	a0,a0,102 # 5328 <malloc+0x1ec>
     2ca:	5b9040ef          	jal	ra,5082 <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e2:	06a50513          	addi	a0,a0,106 # 5348 <malloc+0x20c>
     2e6:	59d040ef          	jal	ra,5082 <printf>
        exit(1);
     2ea:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     350:	01450513          	addi	a0,a0,20 # 5360 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     364:	f8858593          	addi	a1,a1,-120 # 52e8 <malloc+0x1ac>
     368:	10d040ef          	jal	ra,4c74 <write>
     36c:	4785                	li	a5,1
     36e:	02f50d63          	beq	a0,a5,3a8 <badwrite+0xb8>
    printf("write failed\n");
     372:	00005517          	auipc	a0,0x5
     376:	00e50513          	addi	a0,a0,14 # 5380 <malloc+0x244>
     37a:	509040ef          	jal	ra,5082 <printf>
    exit(1);
     37e:	4505                	li	a0,1
     380:	0d5040ef          	jal	ra,4c54 <exit>
      printf("open junk failed\n");
     384:	00005517          	auipc	a0,0x5
     388:	fe450513          	addi	a0,a0,-28 # 5368 <malloc+0x22c>
     38c:	4f7040ef          	jal	ra,5082 <printf>
      exit(1);
     390:	4505                	li	a0,1
     392:	0c3040ef          	jal	ra,4c54 <exit>
    printf("open junk failed\n");
     396:	00005517          	auipc	a0,0x5
     39a:	fd250513          	addi	a0,a0,-46 # 5368 <malloc+0x22c>
     39e:	4e5040ef          	jal	ra,5082 <printf>
    exit(1);
     3a2:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b2:	fb250513          	addi	a0,a0,-78 # 5360 <malloc+0x224>
...
0000000000000480 <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     498:	20c78793          	addi	a5,a5,524 # 76a0 <malloc+0x2564>
     49c:	638c                	ld	a1,0(a5)
     49e:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c6:	ecea0a13          	addi	s4,s4,-306 # 5390 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     54e:	e4e50513          	addi	a0,a0,-434 # 5398 <malloc+0x25c>
     552:	331040ef          	jal	ra,5082 <printf>
      exit(1);
     556:	4505                	li	a0,1
     ...
     564:	e5050513          	addi	a0,a0,-432 # 53b0 <malloc+0x274>
     568:	31b040ef          	jal	ra,5082 <printf>
      exit(1);
     56c:	4505                	li	a0,1
     ...
     57a:	e6a50513          	addi	a0,a0,-406 # 53e0 <malloc+0x2a4>
     57e:	305040ef          	jal	ra,5082 <printf>
      exit(1);
     582:	4505                	li	a0,1
     584:	6d0040ef          	jal	ra,4c54 <exit>
      printf("pipe() failed\n");
     588:	00005517          	auipc	a0,0x5
     58c:	e8850513          	addi	a0,a0,-376 # 5410 <malloc+0x2d4>
     590:	2f3040ef          	jal	ra,5082 <printf>
      exit(1);
     594:	4505                	li	a0,1
     ...
     5a2:	e8250513          	addi	a0,a0,-382 # 5420 <malloc+0x2e4>
     5a6:	2dd040ef          	jal	ra,5082 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
...
00000000000005b0 <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5ca:	0da78793          	addi	a5,a5,218 # 76a0 <malloc+0x2564>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5fe:	e56a0a13          	addi	s4,s4,-426 # 5450 <malloc+0x314>
    n = write(fds[1], "x", 1);
     602:	00005a97          	auipc	s5,0x5
     606:	ce6a8a93          	addi	s5,s5,-794 # 52e8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     68c:	dd050513          	addi	a0,a0,-560 # 5458 <malloc+0x31c>
     690:	1f3040ef          	jal	ra,5082 <printf>
      exit(1);
     694:	4505                	li	a0,1
     ...
     6a2:	dd250513          	addi	a0,a0,-558 # 5470 <malloc+0x334>
     6a6:	1dd040ef          	jal	ra,5082 <printf>
      exit(1);
     6aa:	4505                	li	a0,1
     6ac:	5a8040ef          	jal	ra,4c54 <exit>
      printf("pipe() failed\n");
     6b0:	00005517          	auipc	a0,0x5
     6b4:	d6050513          	addi	a0,a0,-672 # 5410 <malloc+0x2d4>
     6b8:	1cb040ef          	jal	ra,5082 <printf>
      exit(1);
     6bc:	4505                	li	a0,1
     6be:	596040ef          	jal	ra,4c54 <exit>
      printf("pipe write failed\n");
     6c2:	00005517          	auipc	a0,0x5
     6c6:	dde50513          	addi	a0,a0,-546 # 54a0 <malloc+0x364>
     6ca:	1b9040ef          	jal	ra,5082 <printf>
      exit(1);
     6ce:	4505                	li	a0,1
     ...
     6dc:	de050513          	addi	a0,a0,-544 # 54b8 <malloc+0x37c>
     6e0:	1a3040ef          	jal	ra,5082 <printf>
      exit(1);
     6e4:	4505                	li	a0,1
...
00000000000006ea <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     736:	b9e50513          	addi	a0,a0,-1122 # 52d0 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     75a:	b7a50513          	addi	a0,a0,-1158 # 52d0 <malloc+0x194>
     75e:	536040ef          	jal	ra,4c94 <open>
     762:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     764:	4581                	li	a1,0
     766:	00005517          	auipc	a0,0x5
     76a:	b6a50513          	addi	a0,a0,-1174 # 52d0 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     79c:	db058593          	addi	a1,a1,-592 # 5548 <malloc+0x40c>
     7a0:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7d2:	b0250513          	addi	a0,a0,-1278 # 52d0 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     806:	ce650513          	addi	a0,a0,-794 # 54e8 <malloc+0x3ac>
     80a:	079040ef          	jal	ra,5082 <printf>
    exit(1);
     80e:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     81a:	cf250513          	addi	a0,a0,-782 # 5508 <malloc+0x3cc>
     81e:	065040ef          	jal	ra,5082 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     822:	8652                	mv	a2,s4
     824:	85d6                	mv	a1,s5
     826:	00005517          	auipc	a0,0x5
     82a:	cf250513          	addi	a0,a0,-782 # 5518 <malloc+0x3dc>
     82e:	055040ef          	jal	ra,5082 <printf>
    exit(1);
     832:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     83e:	cfe50513          	addi	a0,a0,-770 # 5538 <malloc+0x3fc>
     842:	041040ef          	jal	ra,5082 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     846:	8652                	mv	a2,s4
     848:	85d6                	mv	a1,s5
     84a:	00005517          	auipc	a0,0x5
     84e:	cce50513          	addi	a0,a0,-818 # 5518 <malloc+0x3dc>
     852:	031040ef          	jal	ra,5082 <printf>
    exit(1);
     856:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     864:	cf050513          	addi	a0,a0,-784 # 5550 <malloc+0x414>
     868:	01b040ef          	jal	ra,5082 <printf>
    exit(1);
     86c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     87a:	cfa50513          	addi	a0,a0,-774 # 5570 <malloc+0x434>
     87e:	005040ef          	jal	ra,5082 <printf>
    exit(1);
     882:	4505                	li	a0,1
...
0000000000000888 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8a6:	cee50513          	addi	a0,a0,-786 # 5590 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8ba:	d0298993          	addi	s3,s3,-766 # 55b8 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8be:	00005a97          	auipc	s5,0x5
     8c2:	d32a8a93          	addi	s5,s5,-718 # 55f0 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8fc:	c9850513          	addi	a0,a0,-872 # 5590 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     92c:	c6850513          	addi	a0,a0,-920 # 5590 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     952:	c4a50513          	addi	a0,a0,-950 # 5598 <malloc+0x45c>
     956:	72c040ef          	jal	ra,5082 <printf>
    exit(1);
     95a:	4505                	li	a0,1
     ...
     968:	c6450513          	addi	a0,a0,-924 # 55c8 <malloc+0x48c>
     96c:	716040ef          	jal	ra,5082 <printf>
      exit(1);
     970:	4505                	li	a0,1
     ...
     97e:	c8650513          	addi	a0,a0,-890 # 5600 <malloc+0x4c4>
     982:	700040ef          	jal	ra,5082 <printf>
      exit(1);
     986:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     992:	c9a50513          	addi	a0,a0,-870 # 5628 <malloc+0x4ec>
     996:	6ec040ef          	jal	ra,5082 <printf>
    exit(1);
     99a:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9a6:	ca650513          	addi	a0,a0,-858 # 5648 <malloc+0x50c>
     9aa:	6d8040ef          	jal	ra,5082 <printf>
    exit(1);
     9ae:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9ba:	caa50513          	addi	a0,a0,-854 # 5660 <malloc+0x524>
     9be:	6c4040ef          	jal	ra,5082 <printf>
    exit(1);
     9c2:	4505                	li	a0,1
...
00000000000009c8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9e4:	ca050513          	addi	a0,a0,-864 # 5680 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     a2a:	c5a50513          	addi	a0,a0,-934 # 5680 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a6a:	c2250513          	addi	a0,a0,-990 # 5688 <malloc+0x54c>
     a6e:	614040ef          	jal	ra,5082 <printf>
    exit(1);
     a72:	4505                	li	a0,1
     ...
     a80:	c2c50513          	addi	a0,a0,-980 # 56a8 <malloc+0x56c>
     a84:	5fe040ef          	jal	ra,5082 <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a94:	c4050513          	addi	a0,a0,-960 # 56d0 <malloc+0x594>
     a98:	5ea040ef          	jal	ra,5082 <printf>
    exit(1);
     a9c:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ab4:	bd050513          	addi	a0,a0,-1072 # 5680 <malloc+0x544>
     ...
     ada:	c1a50513          	addi	a0,a0,-998 # 56f0 <malloc+0x5b4>
     ade:	5a4040ef          	jal	ra,5082 <printf>
        exit(1);
     ae2:	4505                	li	a0,1
     ...
     af0:	c2c50513          	addi	a0,a0,-980 # 5718 <malloc+0x5dc>
     af4:	58e040ef          	jal	ra,5082 <printf>
      exit(1);
     af8:	4505                	li	a0,1
     ...
     b06:	c2e50513          	addi	a0,a0,-978 # 5730 <malloc+0x5f4>
     b0a:	578040ef          	jal	ra,5082 <printf>
      exit(1);
     b0e:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b1a:	c4250513          	addi	a0,a0,-958 # 5758 <malloc+0x61c>
     b1e:	564040ef          	jal	ra,5082 <printf>
    exit(1);
     b22:	4505                	li	a0,1
...
0000000000000b28 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b40:	c3450513          	addi	a0,a0,-972 # 5770 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     b54:	c5058593          	addi	a1,a1,-944 # 57a0 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b68:	c0c50513          	addi	a0,a0,-1012 # 5770 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     b7a:	bfa50513          	addi	a0,a0,-1030 # 5770 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8c:	be850513          	addi	a0,a0,-1048 # 5770 <malloc+0x634>
     b90:	104040ef          	jal	ra,4c94 <open>
     b94:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     b96:	460d                	li	a2,3
     b98:	00005597          	auipc	a1,0x5
     b9c:	c5058593          	addi	a1,a1,-944 # 57e8 <malloc+0x6ac>
  ...
  unlink("unlinkread");
     ...
     bf0:	b8450513          	addi	a0,a0,-1148 # 5770 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c0c:	b7850513          	addi	a0,a0,-1160 # 5780 <malloc+0x644>
     c10:	472040ef          	jal	ra,5082 <printf>
    exit(1);
     c14:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c20:	b8c50513          	addi	a0,a0,-1140 # 57a8 <malloc+0x66c>
     c24:	45e040ef          	jal	ra,5082 <printf>
    exit(1);
     c28:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c34:	b9850513          	addi	a0,a0,-1128 # 57c8 <malloc+0x68c>
     c38:	44a040ef          	jal	ra,5082 <printf>
    exit(1);
     c3c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c48:	bac50513          	addi	a0,a0,-1108 # 57f0 <malloc+0x6b4>
     c4c:	436040ef          	jal	ra,5082 <printf>
    exit(1);
     c50:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c5c:	bb850513          	addi	a0,a0,-1096 # 5810 <malloc+0x6d4>
     c60:	422040ef          	jal	ra,5082 <printf>
    exit(1);
     c64:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c70:	bc450513          	addi	a0,a0,-1084 # 5830 <malloc+0x6f4>
     c74:	40e040ef          	jal	ra,5082 <printf>
    exit(1);
     c78:	4505                	li	a0,1
...
0000000000000c7e <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cc0:	ae458593          	addi	a1,a1,-1308 # 57a0 <malloc+0x664>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d98:	acc50513          	addi	a0,a0,-1332 # 5860 <malloc+0x724>
     d9c:	2e6040ef          	jal	ra,5082 <printf>
    exit(1);
     da0:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     dac:	ad050513          	addi	a0,a0,-1328 # 5878 <malloc+0x73c>
     db0:	2d2040ef          	jal	ra,5082 <printf>
    exit(1);
     db4:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     dc0:	ad450513          	addi	a0,a0,-1324 # 5890 <malloc+0x754>
     dc4:	2be040ef          	jal	ra,5082 <printf>
    exit(1);
     dc8:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dd4:	ae050513          	addi	a0,a0,-1312 # 58b0 <malloc+0x774>
     dd8:	2aa040ef          	jal	ra,5082 <printf>
    exit(1);
     ddc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     de8:	afc50513          	addi	a0,a0,-1284 # 58e0 <malloc+0x7a4>
     dec:	296040ef          	jal	ra,5082 <printf>
    exit(1);
     df0:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     dfc:	b0050513          	addi	a0,a0,-1280 # 58f8 <malloc+0x7bc>
     e00:	282040ef          	jal	ra,5082 <printf>
    exit(1);
     e04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e10:	b0450513          	addi	a0,a0,-1276 # 5910 <malloc+0x7d4>
     e14:	26e040ef          	jal	ra,5082 <printf>
    exit(1);
     e18:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e24:	b1850513          	addi	a0,a0,-1256 # 5938 <malloc+0x7fc>
     e28:	25a040ef          	jal	ra,5082 <printf>
    exit(1);
     e2c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e38:	b3450513          	addi	a0,a0,-1228 # 5968 <malloc+0x82c>
     e3c:	246040ef          	jal	ra,5082 <printf>
    exit(1);
     e40:	4505                	li	a0,1
...
0000000000000e46 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e62:	b2a98993          	addi	s3,s3,-1238 # 5988 <malloc+0x84c>
     e66:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e68:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e9a:	b0250513          	addi	a0,a0,-1278 # 5998 <malloc+0x85c>
     e9e:	1e4040ef          	jal	ra,5082 <printf>
      exit(1);
     ea2:	4505                	li	a0,1
...
0000000000000ea8 <bigdir>:
{
  ...
  unlink("bd");
     ...
     ec2:	afa50513          	addi	a0,a0,-1286 # 59b8 <malloc+0x87c>
     ec6:	5df030ef          	jal	ra,4ca4 <unlink>
  fd = open("bd", O_CREATE);
     eca:	20000593          	li	a1,512
     ece:	00005517          	auipc	a0,0x5
     ed2:	aea50513          	addi	a0,a0,-1302 # 59b8 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     eec:	ad0a0a13          	addi	s4,s4,-1328 # 59b8 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f3a:	a8250513          	addi	a0,a0,-1406 # 59b8 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     fa2:	a2250513          	addi	a0,a0,-1502 # 59c0 <malloc+0x884>
     fa6:	0dc040ef          	jal	ra,5082 <printf>
    exit(1);
     faa:	4505                	li	a0,1
     ...
     fbc:	a2850513          	addi	a0,a0,-1496 # 59e0 <malloc+0x8a4>
     fc0:	0c2040ef          	jal	ra,5082 <printf>
      exit(1);
     fc4:	4505                	li	a0,1
     ...
     fd0:	a3c50513          	addi	a0,a0,-1476 # 5a08 <malloc+0x8cc>
     fd4:	0ae040ef          	jal	ra,5082 <printf>
      exit(1);
     fd8:	4505                	li	a0,1
...
000000000000100a <badarg>:
{
    ...
    1028:	25498993          	addi	s3,s3,596 # 5278 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001048 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    109e:	abe78793          	addi	a5,a5,-1346 # 6b58 <malloc+0x1a1c>
  ...
  if(pid == 0){
    ...
    10cc:	4c878793          	addi	a5,a5,1224 # 8590 <big.1280>
    10d0:	00008697          	auipc	a3,0x8
    10d4:	4c068693          	addi	a3,a3,1216 # 9590 <big.1280+0x1000>
      big[i] = 'x';
    ...
    10ea:	4a078523          	sb	zero,1194(a5) # 9590 <big.1280+0x1000>
    char *args2[] = { big, big, big, 0 };
    10ee:	00006797          	auipc	a5,0x6
    10f2:	5b278793          	addi	a5,a5,1458 # 76a0 <malloc+0x2564>
    ...
    1116:	16650513          	addi	a0,a0,358 # 5278 <malloc+0x13c>
    ...
    112a:	98a50513          	addi	a0,a0,-1654 # 5ab0 <malloc+0x974>
    112e:	755030ef          	jal	ra,5082 <printf>
      exit(1);
    1132:	4505                	li	a0,1
    ...
    1142:	8ea50513          	addi	a0,a0,-1814 # 5a28 <malloc+0x8ec>
    1146:	73d030ef          	jal	ra,5082 <printf>
    exit(1);
    114a:	4505                	li	a0,1
    ...
    115a:	8f250513          	addi	a0,a0,-1806 # 5a48 <malloc+0x90c>
    115e:	725030ef          	jal	ra,5082 <printf>
    exit(1);
    1162:	4505                	li	a0,1
    ...
    1174:	8f850513          	addi	a0,a0,-1800 # 5a68 <malloc+0x92c>
    1178:	70b030ef          	jal	ra,5082 <printf>
    exit(1);
    117c:	4505                	li	a0,1
    ...
    118c:	90850513          	addi	a0,a0,-1784 # 5a90 <malloc+0x954>
    1190:	6f3030ef          	jal	ra,5082 <printf>
    exit(1);
    1194:	4505                	li	a0,1
    1196:	2bf030ef          	jal	ra,4c54 <exit>
    printf("fork failed\n");
    119a:	00006517          	auipc	a0,0x6
    119e:	ef650513          	addi	a0,a0,-266 # 7090 <malloc+0x1f54>
    11a2:	6e1030ef          	jal	ra,5082 <printf>
    exit(1);
    11a6:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11d8:	90450513          	addi	a0,a0,-1788 # 5ad8 <malloc+0x99c>
    11dc:	6a7030ef          	jal	ra,5082 <printf>
    exit(1);
    11e0:	4505                	li	a0,1
...
00000000000011e6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1202:	0d250513          	addi	a0,a0,210 # 52d0 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    1220:	0b4a0a13          	addi	s4,s4,180 # 52d0 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    1224:	00005a97          	auipc	s5,0x5
    1228:	914a8a93          	addi	s5,s5,-1772 # 5b38 <malloc+0x9fc>
      int fd = open("truncfile", O_WRONLY);
    122c:	4585                	li	a1,1
    122e:	8552                	mv	a0,s4
    ...
    127c:	89050513          	addi	a0,a0,-1904 # 5b08 <malloc+0x9cc>
    1280:	603030ef          	jal	ra,5082 <printf>
    exit(1);
    1284:	4505                	li	a0,1
    ...
    1290:	89450513          	addi	a0,a0,-1900 # 5b20 <malloc+0x9e4>
    1294:	5ef030ef          	jal	ra,5082 <printf>
        exit(1);
    1298:	4505                	li	a0,1
    ...
    12a6:	8a650513          	addi	a0,a0,-1882 # 5b48 <malloc+0xa0c>
    12aa:	5d9030ef          	jal	ra,5082 <printf>
        exit(1);
    12ae:	4505                	li	a0,1
    ...
    12bc:	018a0a13          	addi	s4,s4,24 # 52d0 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    12c0:	00005a97          	auipc	s5,0x5
    12c4:	8a8a8a93          	addi	s5,s5,-1880 # 5b68 <malloc+0xa2c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    12fe:	fd650513          	addi	a0,a0,-42 # 52d0 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    1314:	81050513          	addi	a0,a0,-2032 # 5b20 <malloc+0x9e4>
    1318:	56b030ef          	jal	ra,5082 <printf>
      exit(1);
    131c:	4505                	li	a0,1
    ...
    132a:	84a50513          	addi	a0,a0,-1974 # 5b70 <malloc+0xa34>
    132e:	555030ef          	jal	ra,5082 <printf>
      exit(1);
    1332:	4505                	li	a0,1
...
0000000000001338 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134a:	f3278793          	addi	a5,a5,-206 # 5278 <malloc+0x13c>
    134e:	fcf43023          	sd	a5,-64(s0)
    1352:	00005797          	auipc	a5,0x5
    1356:	83e78793          	addi	a5,a5,-1986 # 5b90 <malloc+0xa54>
    135a:	fcf43423          	sd	a5,-56(s0)
    135e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1362:	00005517          	auipc	a0,0x5
    1366:	83650513          	addi	a0,a0,-1994 # 5b98 <malloc+0xa5c>
  ...
  if(pid == 0) {
    ...
    1388:	81450513          	addi	a0,a0,-2028 # 5b98 <malloc+0xa5c>
    ...
    13a0:	81c50513          	addi	a0,a0,-2020 # 5bb8 <malloc+0xa7c>
    13a4:	4df030ef          	jal	ra,5082 <printf>
      exit(1);
    13a8:	4505                	li	a0,1
    ...
    13b4:	75850513          	addi	a0,a0,1880 # 5b08 <malloc+0x9cc>
    13b8:	4cb030ef          	jal	ra,5082 <printf>
     exit(1);
    13bc:	4505                	li	a0,1
    ...
    13c8:	7dc50513          	addi	a0,a0,2012 # 5ba0 <malloc+0xa64>
    13cc:	4b7030ef          	jal	ra,5082 <printf>
      exit(1);
    13d0:	4505                	li	a0,1
    ...
    13de:	e9e50513          	addi	a0,a0,-354 # 5278 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1406:	7c650513          	addi	a0,a0,1990 # 5bc8 <malloc+0xa8c>
    140a:	479030ef          	jal	ra,5082 <printf>
      exit(1);
    140e:	4505                	li	a0,1
    ...
    141a:	7ca50513          	addi	a0,a0,1994 # 5be0 <malloc+0xaa4>
    141e:	465030ef          	jal	ra,5082 <printf>
    1422:	bfd1                	j	13f6 <exectest+0xbe>
  fd = open("echo-ok", O_RDONLY);
    1424:	4581                	li	a1,0
    1426:	00004517          	auipc	a0,0x4
    142a:	77250513          	addi	a0,a0,1906 # 5b98 <malloc+0xa5c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    144c:	20050513          	addi	a0,a0,512 # 5648 <malloc+0x50c>
    1450:	433030ef          	jal	ra,5082 <printf>
    exit(1);
    1454:	4505                	li	a0,1
    ...
    1460:	6c450513          	addi	a0,a0,1732 # 5b20 <malloc+0x9e4>
    1464:	41f030ef          	jal	ra,5082 <printf>
    exit(1);
    1468:	4505                	li	a0,1
    146a:	7ea030ef          	jal	ra,4c54 <exit>
  unlink("echo-ok");
    146e:	00004517          	auipc	a0,0x4
    1472:	72a50513          	addi	a0,a0,1834 # 5b98 <malloc+0xa5c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1498:	76450513          	addi	a0,a0,1892 # 5bf8 <malloc+0xabc>
    149c:	3e7030ef          	jal	ra,5082 <printf>
    exit(1);
    14a0:	4505                	li	a0,1
...
00000000000014ac <pipe1>:
{
  ...
  if(pid == 0){
    ...
    153e:	6d650513          	addi	a0,a0,1750 # 5c10 <malloc+0xad4>
    1542:	341030ef          	jal	ra,5082 <printf>
    exit(1);
    1546:	4505                	li	a0,1
    ...
    156c:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xf5>
{
    ...
    15b0:	67c50513          	addi	a0,a0,1660 # 5c28 <malloc+0xaec>
    15b4:	2cf030ef          	jal	ra,5082 <printf>
        exit(1);
    15b8:	4505                	li	a0,1
    ...
    15c4:	68050513          	addi	a0,a0,1664 # 5c40 <malloc+0xb04>
    15c8:	2bb030ef          	jal	ra,5082 <printf>
}
    ...
    15f4:	66850513          	addi	a0,a0,1640 # 5c58 <malloc+0xb1c>
    15f8:	28b030ef          	jal	ra,5082 <printf>
      exit(1);
    15fc:	4505                	li	a0,1
    ...
    1620:	65c50513          	addi	a0,a0,1628 # 5c78 <malloc+0xb3c>
    1624:	25f030ef          	jal	ra,5082 <printf>
    exit(1);
    1628:	4505                	li	a0,1
...
000000000000162e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1682:	48a50513          	addi	a0,a0,1162 # 5b08 <malloc+0x9cc>
    1686:	1fd030ef          	jal	ra,5082 <printf>
      exit(1);
    168a:	4505                	li	a0,1
    ...
    1696:	5fe50513          	addi	a0,a0,1534 # 5c90 <malloc+0xb54>
    169a:	1e9030ef          	jal	ra,5082 <printf>
        exit(1);
    169e:	4505                	li	a0,1
    ...
    16aa:	60250513          	addi	a0,a0,1538 # 5ca8 <malloc+0xb6c>
    16ae:	1d5030ef          	jal	ra,5082 <printf>
        exit(1);
    16b2:	4505                	li	a0,1
...
00000000000016be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1706:	40650513          	addi	a0,a0,1030 # 5b08 <malloc+0x9cc>
    170a:	179030ef          	jal	ra,5082 <printf>
      exit(1);
    170e:	4505                	li	a0,1
    ...
    171e:	3ee50513          	addi	a0,a0,1006 # 5b08 <malloc+0x9cc>
    1722:	161030ef          	jal	ra,5082 <printf>
        exit(1);
    1726:	4505                	li	a0,1
...
0000000000001730 <forkfork>:
{
    ...
    177c:	55050513          	addi	a0,a0,1360 # 5cc8 <malloc+0xb8c>
    1780:	103030ef          	jal	ra,5082 <printf>
      exit(1);
    1784:	4505                	li	a0,1
    1786:	4ce030ef          	jal	ra,4c54 <exit>
{
    ...
    17b8:	52450513          	addi	a0,a0,1316 # 5cd8 <malloc+0xb9c>
    17bc:	0c7030ef          	jal	ra,5082 <printf>
      exit(1);
    17c0:	4505                	li	a0,1
...
00000000000017c6 <reparent2>:
{
  ...
  exit(0);
    ...
    17f2:	8a250513          	addi	a0,a0,-1886 # 7090 <malloc+0x1f54>
    17f6:	08d030ef          	jal	ra,5082 <printf>
      exit(1);
    17fa:	4505                	li	a0,1
...
000000000000180e <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1874:	29850513          	addi	a0,a0,664 # 5b08 <malloc+0x9cc>
    1878:	00b030ef          	jal	ra,5082 <printf>
      exit(1);
    187c:	4505                	li	a0,1
    ...
    1898:	30c50513          	addi	a0,a0,780 # 5ba0 <malloc+0xa64>
    189c:	7e6030ef          	jal	ra,5082 <printf>
          exit(1);
    18a0:	4505                	li	a0,1
    ...
    18f6:	40650513          	addi	a0,a0,1030 # 5cf8 <malloc+0xbbc>
    18fa:	788030ef          	jal	ra,5082 <printf>
            exit(1);
    18fe:	4505                	li	a0,1
    ...
    191a:	3fa50513          	addi	a0,a0,1018 # 5d10 <malloc+0xbd4>
    191e:	764030ef          	jal	ra,5082 <printf>
        exit(1);
    1922:	4505                	li	a0,1
    ...
    1970:	3cc50513          	addi	a0,a0,972 # 5d38 <malloc+0xbfc>
    1974:	70e030ef          	jal	ra,5082 <printf>
        exit(1);
    1978:	4505                	li	a0,1
...
00000000000019e6 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a06:	8e650513          	addi	a0,a0,-1818 # 52e8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a3a:	8b2a8a93          	addi	s5,s5,-1870 # 52e8 <malloc+0x1ac>
      link("cat", "x");
    1a3e:	00004b97          	auipc	s7,0x4
    1a42:	322b8b93          	addi	s7,s7,802 # 5d60 <malloc+0xc24>
    1a46:	a805                	j	1a76 <linkunlink+0x90>
    printf("%s: fork failed\n", s);
    1a48:	85a6                	mv	a1,s1
    1a4a:	00004517          	auipc	a0,0x4
    1a4e:	0be50513          	addi	a0,a0,190 # 5b08 <malloc+0x9cc>
    1a52:	630030ef          	jal	ra,5082 <printf>
    exit(1);
    1a56:	4505                	li	a0,1
...
0000000000001ac0 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1aec:	29850513          	addi	a0,a0,664 # 5d80 <malloc+0xc44>
    1af0:	592030ef          	jal	ra,5082 <printf>
    exit(1);
    1af4:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1b3a:	23250513          	addi	a0,a0,562 # 5d68 <malloc+0xc2c>
    1b3e:	544030ef          	jal	ra,5082 <printf>
    exit(1);
    1b42:	4505                	li	a0,1
    ...
    1b4e:	25e50513          	addi	a0,a0,606 # 5da8 <malloc+0xc6c>
    1b52:	530030ef          	jal	ra,5082 <printf>
      exit(1);
    1b56:	4505                	li	a0,1
    ...
    1b62:	26250513          	addi	a0,a0,610 # 5dc0 <malloc+0xc84>
    1b66:	51c030ef          	jal	ra,5082 <printf>
    exit(1);
    1b6a:	4505                	li	a0,1
...
0000000000001b70 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bd2:	f3a50513          	addi	a0,a0,-198 # 5b08 <malloc+0x9cc>
    1bd6:	4ac030ef          	jal	ra,5082 <printf>
      exit(1);
    1bda:	4505                	li	a0,1
    ...
    1bec:	1f050513          	addi	a0,a0,496 # 5dd8 <malloc+0xc9c>
    1bf0:	492030ef          	jal	ra,5082 <printf>
      exit(1);
    1bf4:	4505                	li	a0,1
...
0000000000001c00 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c5a:	eb250513          	addi	a0,a0,-334 # 5b08 <malloc+0x9cc>
    1c5e:	424030ef          	jal	ra,5082 <printf>
      exit(1);
    1c62:	4505                	li	a0,1
    ...
    1c7e:	17e50513          	addi	a0,a0,382 # 5df8 <malloc+0xcbc>
    1c82:	400030ef          	jal	ra,5082 <printf>
      exit(1);
    1c86:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cce:	14650513          	addi	a0,a0,326 # 5e10 <malloc+0xcd4>
    1cd2:	3b0030ef          	jal	ra,5082 <printf>
    exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1ce2:	e2a50513          	addi	a0,a0,-470 # 5b08 <malloc+0x9cc>
    1ce6:	39c030ef          	jal	ra,5082 <printf>
    exit(1);
    1cea:	4505                	li	a0,1
...
0000000000001cf6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d0a:	99a78793          	addi	a5,a5,-1638 # 76a0 <malloc+0x2564>
  ...
  exit(0);
    ...
    1d70:	0cc50513          	addi	a0,a0,204 # 5e38 <malloc+0xcfc>
    1d74:	30e030ef          	jal	ra,5082 <printf>
      exit(0);
    1d78:	4501                	li	a0,0
    ...
    1d84:	d8850513          	addi	a0,a0,-632 # 5b08 <malloc+0x9cc>
    1d88:	2fa030ef          	jal	ra,5082 <printf>
      exit(1);
    1d8c:	4505                	li	a0,1
...
0000000000001d98 <manywrites>:
{
  ...
  exit(0);
    ...
    1de8:	2ac50513          	addi	a0,a0,684 # 7090 <malloc+0x1f54>
    1dec:	296030ef          	jal	ra,5082 <printf>
      exit(1);
    1df0:	4505                	li	a0,1
    ...
    1e74:	fe850513          	addi	a0,a0,-24 # 5e58 <malloc+0xd1c>
    1e78:	20a030ef          	jal	ra,5082 <printf>
            exit(1);
    1e7c:	4505                	li	a0,1
    ...
    1e8c:	4c050513          	addi	a0,a0,1216 # 5348 <malloc+0x20c>
    1e90:	1f2030ef          	jal	ra,5082 <printf>
            exit(1);
    1e94:	4505                	li	a0,1
...
0000000000001e9e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f00:	c5c78793          	addi	a5,a5,-932 # 6b58 <malloc+0x1a1c>
  ...
  if(ret != -1){
    ...
    1f3a:	f3a50513          	addi	a0,a0,-198 # 5e70 <malloc+0xd34>
    1f3e:	144030ef          	jal	ra,5082 <printf>
    exit(1);
    1f42:	4505                	li	a0,1
    ...
    1f50:	adc50513          	addi	a0,a0,-1316 # 5a28 <malloc+0x8ec>
    1f54:	12e030ef          	jal	ra,5082 <printf>
    exit(1);
    1f58:	4505                	li	a0,1
    ...
    1f66:	ae650513          	addi	a0,a0,-1306 # 5a48 <malloc+0x90c>
    1f6a:	118030ef          	jal	ra,5082 <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7e:	aee50513          	addi	a0,a0,-1298 # 5a68 <malloc+0x92c>
    1f82:	100030ef          	jal	ra,5082 <printf>
    exit(1);
    1f86:	4505                	li	a0,1
    ...
    1f94:	b0050513          	addi	a0,a0,-1280 # 5a90 <malloc+0x954>
    1f98:	0ea030ef          	jal	ra,5082 <printf>
    exit(1);
    1f9c:	4505                	li	a0,1
...
0000000000001fa2 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1fd0:	ee450513          	addi	a0,a0,-284 # 5eb0 <malloc+0xd74>
  ...
  if(n >= 0){
    ...
    1ffa:	eda50513          	addi	a0,a0,-294 # 5ed0 <malloc+0xd94>
    1ffe:	084030ef          	jal	ra,5082 <printf>
    exit(1);
    2002:	4505                	li	a0,1
    2004:	451020ef          	jal	ra,4c54 <exit>
    printf("sbrk(rwsbrk) failed\n");
    2008:	00004517          	auipc	a0,0x4
    200c:	e7050513          	addi	a0,a0,-400 # 5e78 <malloc+0xd3c>
    2010:	072030ef          	jal	ra,5082 <printf>
    exit(1);
    2014:	4505                	li	a0,1
    2016:	43f020ef          	jal	ra,4c54 <exit>
    printf("sbrk(rwsbrk) shrink failed\n");
    201a:	00004517          	auipc	a0,0x4
    201e:	e7650513          	addi	a0,a0,-394 # 5e90 <malloc+0xd54>
    2022:	060030ef          	jal	ra,5082 <printf>
    exit(1);
    2026:	4505                	li	a0,1
    2028:	42d020ef          	jal	ra,4c54 <exit>
    printf("open(rwsbrk) failed\n");
    202c:	00004517          	auipc	a0,0x4
    2030:	e8c50513          	addi	a0,a0,-372 # 5eb8 <malloc+0xd7c>
    2034:	04e030ef          	jal	ra,5082 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2048:	e6c50513          	addi	a0,a0,-404 # 5eb0 <malloc+0xd74>
    204c:	459020ef          	jal	ra,4ca4 <unlink>
  fd = open("README", O_RDONLY);
    2050:	4581                	li	a1,0
    2052:	00003517          	auipc	a0,0x3
    2056:	3fe50513          	addi	a0,a0,1022 # 5450 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    2078:	e8c50513          	addi	a0,a0,-372 # 5f00 <malloc+0xdc4>
    207c:	006030ef          	jal	ra,5082 <printf>
    exit(1);
    2080:	4505                	li	a0,1
    2082:	3d3020ef          	jal	ra,4c54 <exit>
    printf("open(README) failed\n");
    2086:	00003517          	auipc	a0,0x3
    208a:	3d250513          	addi	a0,a0,978 # 5458 <malloc+0x31c>
    208e:	7f5020ef          	jal	ra,5082 <printf>
    exit(1);
    2092:	4505                	li	a0,1
...
00000000000020a4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    20f0:	e3c50513          	addi	a0,a0,-452 # 5f28 <malloc+0xdec>
    20f4:	78f020ef          	jal	ra,5082 <printf>
    exit(1);
    20f8:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2130:	e1c50513          	addi	a0,a0,-484 # 5f48 <malloc+0xe0c>
    2134:	74f020ef          	jal	ra,5082 <printf>
    exit(1);
    2138:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    217a:	e3250513          	addi	a0,a0,-462 # 5fa8 <malloc+0xe6c>
    217e:	705020ef          	jal	ra,5082 <printf>
    exit(1);
    2182:	4505                	li	a0,1
    ...
    2194:	dd850513          	addi	a0,a0,-552 # 5f68 <malloc+0xe2c>
    2198:	6eb020ef          	jal	ra,5082 <printf>
      exit(1);
    219c:	4505                	li	a0,1
    ...
    21a8:	de450513          	addi	a0,a0,-540 # 5f88 <malloc+0xe4c>
    21ac:	6d7020ef          	jal	ra,5082 <printf>
    exit(1);
    21b0:	4505                	li	a0,1
...
00000000000021d0 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2290:	d3c50513          	addi	a0,a0,-708 # 5fc8 <malloc+0xe8c>
    2294:	5ef020ef          	jal	ra,5082 <printf>
    exit(1);
    2298:	4505                	li	a0,1
    ...
    22a4:	d7050513          	addi	a0,a0,-656 # 6010 <malloc+0xed4>
    22a8:	5db020ef          	jal	ra,5082 <printf>
    exit(1);
    22ac:	4505                	li	a0,1
    ...
    22bc:	d7850513          	addi	a0,a0,-648 # 6030 <malloc+0xef4>
    22c0:	5c3020ef          	jal	ra,5082 <printf>
    exit(1);
    22c4:	4505                	li	a0,1
    ...
    22d4:	da050513          	addi	a0,a0,-608 # 6070 <malloc+0xf34>
    22d8:	5ab020ef          	jal	ra,5082 <printf>
    exit(1);
    22dc:	4505                	li	a0,1
    ...
    22e8:	dbc50513          	addi	a0,a0,-580 # 60a0 <malloc+0xf64>
    22ec:	597020ef          	jal	ra,5082 <printf>
    exit(1);
    22f0:	4505                	li	a0,1
    ...
    2300:	ddc50513          	addi	a0,a0,-548 # 60d8 <malloc+0xf9c>
    2304:	57f020ef          	jal	ra,5082 <printf>
    exit(1);
    2308:	4505                	li	a0,1
...
000000000000230e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    232e:	dd650513          	addi	a0,a0,-554 # 6100 <malloc+0xfc4>
    2332:	163020ef          	jal	ra,4c94 <open>
    2336:	84aa                	mv	s1,a0
  unlink("sbrk");
    2338:	00004517          	auipc	a0,0x4
    233c:	dc850513          	addi	a0,a0,-568 # 6100 <malloc+0xfc4>
  ...
  if(pipe((int *) a) != 0){
    ...
    237c:	d9050513          	addi	a0,a0,-624 # 6108 <malloc+0xfcc>
    2380:	503020ef          	jal	ra,5082 <printf>
    exit(1);
    2384:	4505                	li	a0,1
    ...
    2390:	d9450513          	addi	a0,a0,-620 # 6120 <malloc+0xfe4>
    2394:	4ef020ef          	jal	ra,5082 <printf>
    exit(1);
    2398:	4505                	li	a0,1
    ...
    23a4:	87050513          	addi	a0,a0,-1936 # 5c10 <malloc+0xad4>
    23a8:	4db020ef          	jal	ra,5082 <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023b2 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    23c6:	d7650513          	addi	a0,a0,-650 # 6138 <malloc+0xffc>
  ...
  close(fd);
    ...
    23fe:	72650513          	addi	a0,a0,1830 # 5b20 <malloc+0x9e4>
    2402:	481020ef          	jal	ra,5082 <printf>
    exit(1);
    2406:	4505                	li	a0,1
...
000000000000240c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2434:	c6050513          	addi	a0,a0,-928 # 7090 <malloc+0x1f54>
    2438:	44b020ef          	jal	ra,5082 <printf>
    exit(1);
    243c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    246e:	c2650513          	addi	a0,a0,-986 # 7090 <malloc+0x1f54>
    2472:	411020ef          	jal	ra,5082 <printf>
    exit(1);
    2476:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24ae:	be650513          	addi	a0,a0,-1050 # 7090 <malloc+0x1f54>
    24b2:	3d1020ef          	jal	ra,5082 <printf>
    exit(1);
    24b6:	4505                	li	a0,1
...
0000000000002598 <execout>:
{
  ...
  exit(0);
    ...
    25ce:	ac650513          	addi	a0,a0,-1338 # 7090 <malloc+0x1f54>
    25d2:	2b1020ef          	jal	ra,5082 <printf>
      exit(1);
    25d6:	4505                	li	a0,1
    ...
    260e:	c6e50513          	addi	a0,a0,-914 # 5278 <malloc+0x13c>
    2612:	faa43c23          	sd	a0,-72(s0)
    2616:	00003797          	auipc	a5,0x3
    261a:	cd278793          	addi	a5,a5,-814 # 52e8 <malloc+0x1ac>
...
0000000000002634 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2664:	b6050513          	addi	a0,a0,-1184 # 61c0 <malloc+0x1084>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    267a:	bc250513          	addi	a0,a0,-1086 # 6238 <malloc+0x10fc>
  ...
  unlink("12345678901234");
    ...
    26fe:	a4650513          	addi	a0,a0,-1466 # 6140 <malloc+0x1004>
    2702:	181020ef          	jal	ra,5082 <printf>
    exit(1);
    2706:	4505                	li	a0,1
    ...
    2712:	a7a50513          	addi	a0,a0,-1414 # 6188 <malloc+0x104c>
    2716:	16d020ef          	jal	ra,5082 <printf>
    exit(1);
    271a:	4505                	li	a0,1
    ...
    2726:	ace50513          	addi	a0,a0,-1330 # 61f0 <malloc+0x10b4>
    272a:	159020ef          	jal	ra,5082 <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    273a:	b3250513          	addi	a0,a0,-1230 # 6268 <malloc+0x112c>
    273e:	145020ef          	jal	ra,5082 <printf>
    exit(1);
    2742:	4505                	li	a0,1
    ...
    274e:	b7e50513          	addi	a0,a0,-1154 # 62c8 <malloc+0x118c>
    2752:	131020ef          	jal	ra,5082 <printf>
    exit(1);
    2756:	4505                	li	a0,1
    ...
    2762:	bc250513          	addi	a0,a0,-1086 # 6320 <malloc+0x11e4>
    2766:	11d020ef          	jal	ra,5082 <printf>
    exit(1);
    276a:	4505                	li	a0,1
...
0000000000002770 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27aa:	bb250513          	addi	a0,a0,-1102 # 6358 <malloc+0x121c>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    27d6:	b9650513          	addi	a0,a0,-1130 # 6368 <malloc+0x122c>
    27da:	0a9020ef          	jal	ra,5082 <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    297a:	a1250513          	addi	a0,a0,-1518 # 6388 <malloc+0x124c>
    297e:	704020ef          	jal	ra,5082 <printf>
...
0000000000002984 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    29e0:	9e450513          	addi	a0,a0,-1564 # 63c0 <malloc+0x1284>
    29e4:	69e020ef          	jal	ra,5082 <printf>
    exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f4:	9e850513          	addi	a0,a0,-1560 # 63d8 <malloc+0x129c>
    29f8:	68a020ef          	jal	ra,5082 <printf>
    exit(1);
    29fc:	4505                	li	a0,1
    ...
    2a08:	a0450513          	addi	a0,a0,-1532 # 6408 <malloc+0x12cc>
    2a0c:	676020ef          	jal	ra,5082 <printf>
    exit(1);
    2a10:	4505                	li	a0,1
    ...
    2a1c:	a1850513          	addi	a0,a0,-1512 # 6430 <malloc+0x12f4>
    2a20:	662020ef          	jal	ra,5082 <printf>
    exit(1);
    2a24:	4505                	li	a0,1
...
0000000000002a2a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2a7c:	09050513          	addi	a0,a0,144 # 5b08 <malloc+0x9cc>
    2a80:	602020ef          	jal	ra,5082 <printf>
    exit(1);
    2a84:	4505                	li	a0,1
    ...
    2a90:	93450513          	addi	a0,a0,-1740 # 63c0 <malloc+0x1284>
    2a94:	5ee020ef          	jal	ra,5082 <printf>
      exit(1);
    2a98:	4505                	li	a0,1
    ...
    2aa4:	9a850513          	addi	a0,a0,-1624 # 6448 <malloc+0x130c>
    2aa8:	5da020ef          	jal	ra,5082 <printf>
      exit(1);
    2aac:	4505                	li	a0,1
    ...
    2ab8:	95450513          	addi	a0,a0,-1708 # 6408 <malloc+0x12cc>
    2abc:	5c6020ef          	jal	ra,5082 <printf>
      exit(1);
    2ac0:	4505                	li	a0,1
...
0000000000002ad6 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b32:	89250513          	addi	a0,a0,-1902 # 63c0 <malloc+0x1284>
    2b36:	54c020ef          	jal	ra,5082 <printf>
    exit(1);
    2b3a:	4505                	li	a0,1
    ...
    2b46:	92650513          	addi	a0,a0,-1754 # 6468 <malloc+0x132c>
    2b4a:	538020ef          	jal	ra,5082 <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5a:	93250513          	addi	a0,a0,-1742 # 6488 <malloc+0x134c>
    2b5e:	524020ef          	jal	ra,5082 <printf>
    exit(1);
    2b62:	4505                	li	a0,1
    ...
    2b6e:	93650513          	addi	a0,a0,-1738 # 64a0 <malloc+0x1364>
    2b72:	510020ef          	jal	ra,5082 <printf>
    exit(1);
    2b76:	4505                	li	a0,1
...
0000000000002b7c <subdir>:
{
  ...
  unlink("ff");
    ...
    2b8e:	a5e50513          	addi	a0,a0,-1442 # 65e8 <malloc+0x14ac>
    2b92:	112020ef          	jal	ra,4ca4 <unlink>
  if(mkdir("dd") != 0){
    2b96:	00004517          	auipc	a0,0x4
    2b9a:	92250513          	addi	a0,a0,-1758 # 64b8 <malloc+0x137c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bae:	92e50513          	addi	a0,a0,-1746 # 64d8 <malloc+0x139c>
  ...
  write(fd, "ff", 2);
    ...
    2bc2:	a2a58593          	addi	a1,a1,-1494 # 65e8 <malloc+0x14ac>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2bf8:	96450513          	addi	a0,a0,-1692 # 6558 <malloc+0x141c>
  ...
  write(fd, "FF", 2);
    ...
    2c0c:	98058593          	addi	a1,a1,-1664 # 6588 <malloc+0x144c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c20:	97450513          	addi	a0,a0,-1676 # 6590 <malloc+0x1454>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d06:	85650513          	addi	a0,a0,-1962 # 6558 <malloc+0x141c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d1a:	a5a50513          	addi	a0,a0,-1446 # 6770 <malloc+0x1634>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d2e:	a7650513          	addi	a0,a0,-1418 # 67a0 <malloc+0x1664>
  ...
  if(unlink("dd") < 0){
    ...
    2e8c:	63850513          	addi	a0,a0,1592 # 64c0 <malloc+0x1384>
    2e90:	1f2020ef          	jal	ra,5082 <printf>
    exit(1);
    2e94:	4505                	li	a0,1
    ...
    2ea0:	64450513          	addi	a0,a0,1604 # 64e0 <malloc+0x13a4>
    2ea4:	1de020ef          	jal	ra,5082 <printf>
    exit(1);
    2ea8:	4505                	li	a0,1
    ...
    2eb4:	65050513          	addi	a0,a0,1616 # 6500 <malloc+0x13c4>
    2eb8:	1ca020ef          	jal	ra,5082 <printf>
    exit(1);
    2ebc:	4505                	li	a0,1
    ...
    2ec8:	67450513          	addi	a0,a0,1652 # 6538 <malloc+0x13fc>
    2ecc:	1b6020ef          	jal	ra,5082 <printf>
    exit(1);
    2ed0:	4505                	li	a0,1
    ...
    2edc:	69050513          	addi	a0,a0,1680 # 6568 <malloc+0x142c>
    2ee0:	1a2020ef          	jal	ra,5082 <printf>
    exit(1);
    2ee4:	4505                	li	a0,1
    ...
    2ef0:	6b450513          	addi	a0,a0,1716 # 65a0 <malloc+0x1464>
    2ef4:	18e020ef          	jal	ra,5082 <printf>
    exit(1);
    2ef8:	4505                	li	a0,1
    ...
    2f04:	6c050513          	addi	a0,a0,1728 # 65c0 <malloc+0x1484>
    2f08:	17a020ef          	jal	ra,5082 <printf>
    exit(1);
    2f0c:	4505                	li	a0,1
    ...
    2f18:	6dc50513          	addi	a0,a0,1756 # 65f0 <malloc+0x14b4>
    2f1c:	166020ef          	jal	ra,5082 <printf>
    exit(1);
    2f20:	4505                	li	a0,1
    ...
    2f2c:	6f050513          	addi	a0,a0,1776 # 6618 <malloc+0x14dc>
    2f30:	152020ef          	jal	ra,5082 <printf>
    exit(1);
    2f34:	4505                	li	a0,1
    ...
    2f40:	6fc50513          	addi	a0,a0,1788 # 6638 <malloc+0x14fc>
    2f44:	13e020ef          	jal	ra,5082 <printf>
    exit(1);
    2f48:	4505                	li	a0,1
    ...
    2f54:	71050513          	addi	a0,a0,1808 # 6660 <malloc+0x1524>
    2f58:	12a020ef          	jal	ra,5082 <printf>
    exit(1);
    2f5c:	4505                	li	a0,1
    ...
    2f68:	72450513          	addi	a0,a0,1828 # 6688 <malloc+0x154c>
    2f6c:	116020ef          	jal	ra,5082 <printf>
    exit(1);
    2f70:	4505                	li	a0,1
    ...
    2f7c:	74050513          	addi	a0,a0,1856 # 66b8 <malloc+0x157c>
    2f80:	102020ef          	jal	ra,5082 <printf>
    exit(1);
    2f84:	4505                	li	a0,1
    ...
    2f90:	75c50513          	addi	a0,a0,1884 # 66e8 <malloc+0x15ac>
    2f94:	0ee020ef          	jal	ra,5082 <printf>
    exit(1);
    2f98:	4505                	li	a0,1
    ...
    2fa4:	76050513          	addi	a0,a0,1888 # 6700 <malloc+0x15c4>
    2fa8:	0da020ef          	jal	ra,5082 <printf>
    exit(1);
    2fac:	4505                	li	a0,1
    ...
    2fb8:	76c50513          	addi	a0,a0,1900 # 6720 <malloc+0x15e4>
    2fbc:	0c6020ef          	jal	ra,5082 <printf>
    exit(1);
    2fc0:	4505                	li	a0,1
    ...
    2fcc:	77850513          	addi	a0,a0,1912 # 6740 <malloc+0x1604>
    2fd0:	0b2020ef          	jal	ra,5082 <printf>
    exit(1);
    2fd4:	4505                	li	a0,1
    ...
    2fe0:	7a450513          	addi	a0,a0,1956 # 6780 <malloc+0x1644>
    2fe4:	09e020ef          	jal	ra,5082 <printf>
    exit(1);
    2fe8:	4505                	li	a0,1
    ...
    2ff4:	7c050513          	addi	a0,a0,1984 # 67b0 <malloc+0x1674>
    2ff8:	08a020ef          	jal	ra,5082 <printf>
    exit(1);
    2ffc:	4505                	li	a0,1
    ...
    3008:	7cc50513          	addi	a0,a0,1996 # 67d0 <malloc+0x1694>
    300c:	076020ef          	jal	ra,5082 <printf>
    exit(1);
    3010:	4505                	li	a0,1
    ...
    301c:	7d850513          	addi	a0,a0,2008 # 67f0 <malloc+0x16b4>
    3020:	062020ef          	jal	ra,5082 <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3030:	7e450513          	addi	a0,a0,2020 # 6810 <malloc+0x16d4>
    3034:	04e020ef          	jal	ra,5082 <printf>
    exit(1);
    3038:	4505                	li	a0,1
    ...
    3044:	80050513          	addi	a0,a0,-2048 # 6840 <malloc+0x1704>
    3048:	03a020ef          	jal	ra,5082 <printf>
    exit(1);
    304c:	4505                	li	a0,1
    ...
    3058:	81450513          	addi	a0,a0,-2028 # 6868 <malloc+0x172c>
    305c:	026020ef          	jal	ra,5082 <printf>
    exit(1);
    3060:	4505                	li	a0,1
    ...
    306c:	82850513          	addi	a0,a0,-2008 # 6890 <malloc+0x1754>
    3070:	012020ef          	jal	ra,5082 <printf>
    exit(1);
    3074:	4505                	li	a0,1
    ...
    3080:	83c50513          	addi	a0,a0,-1988 # 68b8 <malloc+0x177c>
    3084:	7ff010ef          	jal	ra,5082 <printf>
    exit(1);
    3088:	4505                	li	a0,1
    ...
    3094:	84850513          	addi	a0,a0,-1976 # 68d8 <malloc+0x179c>
    3098:	7eb010ef          	jal	ra,5082 <printf>
    exit(1);
    309c:	4505                	li	a0,1
    ...
    30a8:	85450513          	addi	a0,a0,-1964 # 68f8 <malloc+0x17bc>
    30ac:	7d7010ef          	jal	ra,5082 <printf>
    exit(1);
    30b0:	4505                	li	a0,1
    ...
    30bc:	86850513          	addi	a0,a0,-1944 # 6920 <malloc+0x17e4>
    30c0:	7c3010ef          	jal	ra,5082 <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d0:	87450513          	addi	a0,a0,-1932 # 6940 <malloc+0x1804>
    30d4:	7af010ef          	jal	ra,5082 <printf>
    exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e4:	88050513          	addi	a0,a0,-1920 # 6960 <malloc+0x1824>
    30e8:	79b010ef          	jal	ra,5082 <printf>
    exit(1);
    30ec:	4505                	li	a0,1
    ...
    30f8:	89450513          	addi	a0,a0,-1900 # 6988 <malloc+0x184c>
    30fc:	787010ef          	jal	ra,5082 <printf>
    exit(1);
    3100:	4505                	li	a0,1
    ...
    310c:	51050513          	addi	a0,a0,1296 # 6618 <malloc+0x14dc>
    3110:	773010ef          	jal	ra,5082 <printf>
    exit(1);
    3114:	4505                	li	a0,1
    ...
    3120:	88c50513          	addi	a0,a0,-1908 # 69a8 <malloc+0x186c>
    3124:	75f010ef          	jal	ra,5082 <printf>
    exit(1);
    3128:	4505                	li	a0,1
    ...
    3134:	89850513          	addi	a0,a0,-1896 # 69c8 <malloc+0x188c>
    3138:	74b010ef          	jal	ra,5082 <printf>
    exit(1);
    313c:	4505                	li	a0,1
    ...
    3148:	8b450513          	addi	a0,a0,-1868 # 69f8 <malloc+0x18bc>
    314c:	737010ef          	jal	ra,5082 <printf>
    exit(1);
    3150:	4505                	li	a0,1
    ...
    315c:	8c050513          	addi	a0,a0,-1856 # 6a18 <malloc+0x18dc>
    3160:	723010ef          	jal	ra,5082 <printf>
    exit(1);
    3164:	4505                	li	a0,1
...
000000000000316a <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    31f6:	84650513          	addi	a0,a0,-1978 # 6a38 <malloc+0x18fc>
    31fa:	689010ef          	jal	ra,5082 <printf>
    exit(1);
    31fe:	4505                	li	a0,1
    ...
    320a:	84a50513          	addi	a0,a0,-1974 # 6a50 <malloc+0x1914>
    320e:	675010ef          	jal	ra,5082 <printf>
    exit(1);
    3212:	4505                	li	a0,1
    ...
    321e:	84e50513          	addi	a0,a0,-1970 # 6a68 <malloc+0x192c>
    3222:	661010ef          	jal	ra,5082 <printf>
    exit(1);
    3226:	4505                	li	a0,1
    ...
    3232:	85250513          	addi	a0,a0,-1966 # 6a80 <malloc+0x1944>
    3236:	64d010ef          	jal	ra,5082 <printf>
    exit(1);
    323a:	4505                	li	a0,1
    ...
    3246:	1ee50513          	addi	a0,a0,494 # 6430 <malloc+0x12f4>
    324a:	639010ef          	jal	ra,5082 <printf>
    exit(1);
    324e:	4505                	li	a0,1
    ...
    325a:	84a50513          	addi	a0,a0,-1974 # 6aa0 <malloc+0x1964>
    325e:	625010ef          	jal	ra,5082 <printf>
    exit(1);
    3262:	4505                	li	a0,1
    ...
    326e:	85e50513          	addi	a0,a0,-1954 # 6ac8 <malloc+0x198c>
    3272:	611010ef          	jal	ra,5082 <printf>
    exit(1);
    3276:	4505                	li	a0,1
    ...
    3282:	86a50513          	addi	a0,a0,-1942 # 6ae8 <malloc+0x19ac>
    3286:	5fd010ef          	jal	ra,5082 <printf>
    exit(1);
    328a:	4505                	li	a0,1
...
0000000000003290 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32a6:	86650513          	addi	a0,a0,-1946 # 6b08 <malloc+0x19cc>
  ...
  if(chdir("dirfile") == 0){
    ...
    32ba:	85250513          	addi	a0,a0,-1966 # 6b08 <malloc+0x19cc>
    32be:	207010ef          	jal	ra,4cc4 <chdir>
    32c2:	c569                	beqz	a0,338c <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    32c4:	4581                	li	a1,0
    32c6:	00004517          	auipc	a0,0x4
    32ca:	88a50513          	addi	a0,a0,-1910 # 6b50 <malloc+0x1a14>
  ...
  fd = open(".", 0);
    ...
    334a:	61a50513          	addi	a0,a0,1562 # 5960 <malloc+0x824>
    334e:	147010ef          	jal	ra,4c94 <open>
    3352:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3354:	4605                	li	a2,1
    3356:	00002597          	auipc	a1,0x2
    335a:	f9258593          	addi	a1,a1,-110 # 52e8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    337e:	79650513          	addi	a0,a0,1942 # 6b10 <malloc+0x19d4>
    3382:	501010ef          	jal	ra,5082 <printf>
    exit(1);
    3386:	4505                	li	a0,1
    ...
    3392:	7a250513          	addi	a0,a0,1954 # 6b30 <malloc+0x19f4>
    3396:	4ed010ef          	jal	ra,5082 <printf>
    exit(1);
    339a:	4505                	li	a0,1
    ...
    33a6:	7be50513          	addi	a0,a0,1982 # 6b60 <malloc+0x1a24>
    33aa:	4d9010ef          	jal	ra,5082 <printf>
    exit(1);
    33ae:	4505                	li	a0,1
    ...
    33ba:	7aa50513          	addi	a0,a0,1962 # 6b60 <malloc+0x1a24>
    33be:	4c5010ef          	jal	ra,5082 <printf>
    exit(1);
    33c2:	4505                	li	a0,1
    ...
    33ce:	7be50513          	addi	a0,a0,1982 # 6b88 <malloc+0x1a4c>
    33d2:	4b1010ef          	jal	ra,5082 <printf>
    exit(1);
    33d6:	4505                	li	a0,1
    ...
    33e2:	7d250513          	addi	a0,a0,2002 # 6bb0 <malloc+0x1a74>
    33e6:	49d010ef          	jal	ra,5082 <printf>
    exit(1);
    33ea:	4505                	li	a0,1
    ...
    33f6:	7e650513          	addi	a0,a0,2022 # 6bd8 <malloc+0x1a9c>
    33fa:	489010ef          	jal	ra,5082 <printf>
    exit(1);
    33fe:	4505                	li	a0,1
    ...
    340a:	7fa50513          	addi	a0,a0,2042 # 6c00 <malloc+0x1ac4>
    340e:	475010ef          	jal	ra,5082 <printf>
    exit(1);
    3412:	4505                	li	a0,1
    ...
    341e:	80650513          	addi	a0,a0,-2042 # 6c20 <malloc+0x1ae4>
    3422:	461010ef          	jal	ra,5082 <printf>
    exit(1);
    3426:	4505                	li	a0,1
    ...
    3432:	81a50513          	addi	a0,a0,-2022 # 6c48 <malloc+0x1b0c>
    3436:	44d010ef          	jal	ra,5082 <printf>
    exit(1);
    343a:	4505                	li	a0,1
...
0000000000003440 <iref>:
{
    ...
    345e:	806a0a13          	addi	s4,s4,-2042 # 6c60 <malloc+0x1b24>
    mkdir("");
    3462:	00003497          	auipc	s1,0x3
    3466:	30648493          	addi	s1,s1,774 # 6768 <malloc+0x162c>
    link("README", "");
    346a:	00002a97          	auipc	s5,0x2
    346e:	fe6a8a93          	addi	s5,s5,-26 # 5450 <malloc+0x314>
    fd = open("xx", O_CREATE);
    3472:	00003997          	auipc	s3,0x3
    3476:	6e698993          	addi	s3,s3,1766 # 6b58 <malloc+0x1a1c>
    347a:	a835                	j	34b6 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    347c:	85da                	mv	a1,s6
    347e:	00003517          	auipc	a0,0x3
    3482:	7ea50513          	addi	a0,a0,2026 # 6c68 <malloc+0x1b2c>
    3486:	3fd010ef          	jal	ra,5082 <printf>
      exit(1);
    348a:	4505                	li	a0,1
    ...
    3496:	7ee50513          	addi	a0,a0,2030 # 6c80 <malloc+0x1b44>
    349a:	3e9010ef          	jal	ra,5082 <printf>
      exit(1);
    349e:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    34fe:	f8698993          	addi	s3,s3,-122 # 6480 <malloc+0x1344>
    unlink("irefd");
    3502:	00003917          	auipc	s2,0x3
    3506:	75e90913          	addi	s2,s2,1886 # 6c60 <malloc+0x1b24>
    chdir("..");
    350a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    351e:	f0e50513          	addi	a0,a0,-242 # 6428 <malloc+0x12ec>
...
000000000000353a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    354a:	75250513          	addi	a0,a0,1874 # 6c98 <malloc+0x1b5c>
  ...
  if(pid == 0){
    ...
    3566:	73650513          	addi	a0,a0,1846 # 6c98 <malloc+0x1b5c>
    ...
    3578:	74450513          	addi	a0,a0,1860 # 6cb8 <malloc+0x1b7c>
    357c:	307010ef          	jal	ra,5082 <printf>
      exit(1);
    3580:	4505                	li	a0,1
    ...
    358c:	71850513          	addi	a0,a0,1816 # 6ca0 <malloc+0x1b64>
    3590:	2f3010ef          	jal	ra,5082 <printf>
    exit(1);
    3594:	4505                	li	a0,1
    ...
    35a0:	56c50513          	addi	a0,a0,1388 # 5b08 <malloc+0x9cc>
    35a4:	2df010ef          	jal	ra,5082 <printf>
    exit(1);
    35a8:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    35be:	6de50513          	addi	a0,a0,1758 # 6c98 <malloc+0x1b5c>
    35c2:	6e2010ef          	jal	ra,4ca4 <unlink>
    35c6:	c919                	beqz	a0,35dc <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    35c8:	85a6                	mv	a1,s1
    35ca:	00002517          	auipc	a0,0x2
    35ce:	72e50513          	addi	a0,a0,1838 # 5cf8 <malloc+0xbbc>
    35d2:	2b1010ef          	jal	ra,5082 <printf>
    exit(1);
    35d6:	4505                	li	a0,1
...
00000000000035ec <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    35fc:	6e850513          	addi	a0,a0,1768 # 6ce0 <malloc+0x1ba4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    361c:	6c850513          	addi	a0,a0,1736 # 6ce0 <malloc+0x1ba4>
  ...
  pause(10); // one second
    ...
    3644:	68850513          	addi	a0,a0,1672 # 5cc8 <malloc+0xb8c>
    3648:	23b010ef          	jal	ra,5082 <printf>
    exit(1);
    364c:	4505                	li	a0,1
    364e:	606010ef          	jal	ra,4c54 <exit>
      int fd = open("stopforking", 0);
    3652:	00003497          	auipc	s1,0x3
    3656:	68e48493          	addi	s1,s1,1678 # 6ce0 <malloc+0x1ba4>
    365a:	4581                	li	a1,0
    365c:	8526                	mv	a0,s1
...
0000000000003684 <killstatus>:
{
  ...
  exit(0);
    ...
    36d6:	43650513          	addi	a0,a0,1078 # 5b08 <malloc+0x9cc>
    36da:	1a9010ef          	jal	ra,5082 <printf>
      exit(1);
    36de:	4505                	li	a0,1
    ...
    36f0:	60450513          	addi	a0,a0,1540 # 6cf0 <malloc+0x1bb4>
    36f4:	18f010ef          	jal	ra,5082 <printf>
       exit(1);
    36f8:	4505                	li	a0,1
...
00000000000036fe <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3724:	5a850513          	addi	a0,a0,1448 # 5cc8 <malloc+0xb8c>
    3728:	15b010ef          	jal	ra,5082 <printf>
    exit(1);
    372c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3746:	3c650513          	addi	a0,a0,966 # 5b08 <malloc+0x9cc>
    374a:	139010ef          	jal	ra,5082 <printf>
    exit(1);
    374e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3776:	b7658593          	addi	a1,a1,-1162 # 52e8 <malloc+0x1ac>
    ...
    3798:	37450513          	addi	a0,a0,884 # 5b08 <malloc+0x9cc>
    379c:	0e7010ef          	jal	ra,5082 <printf>
     exit(1);
    37a0:	4505                	li	a0,1
    ...
    37ac:	56850513          	addi	a0,a0,1384 # 6d10 <malloc+0x1bd4>
    37b0:	0d3010ef          	jal	ra,5082 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    37dc:	55050513          	addi	a0,a0,1360 # 6d28 <malloc+0x1bec>
    37e0:	0a3010ef          	jal	ra,5082 <printf>
}
  ...
  printf("kill... ");
    ...
    3800:	54450513          	addi	a0,a0,1348 # 6d40 <malloc+0x1c04>
    3804:	07f010ef          	jal	ra,5082 <printf>
  kill(pid1);
    3808:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    381e:	53650513          	addi	a0,a0,1334 # 6d50 <malloc+0x1c14>
    3822:	061010ef          	jal	ra,5082 <printf>
  wait(0);
    3826:	4501                	li	a0,0
...
000000000000383a <reparent>:
{
  ...
  exit(0);
    ...
    387e:	28e50513          	addi	a0,a0,654 # 5b08 <malloc+0x9cc>
    3882:	001010ef          	jal	ra,5082 <printf>
      exit(1);
    3886:	4505                	li	a0,1
    ...
    3892:	40250513          	addi	a0,a0,1026 # 5c90 <malloc+0xb54>
    3896:	7ec010ef          	jal	ra,5082 <printf>
        exit(1);
    389a:	4505                	li	a0,1
...
00000000000038ba <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    38f6:	31e50513          	addi	a0,a0,798 # 5c10 <malloc+0xad4>
    38fa:	788010ef          	jal	ra,5082 <printf>
    exit(1);
    38fe:	4505                	li	a0,1
    ...
    3922:	ab258593          	addi	a1,a1,-1358 # 73d0 <malloc+0x2294>
    ...
    393e:	42658593          	addi	a1,a1,1062 # 6d60 <malloc+0x1c24>
  ...
  c = sbrk(PGSIZE);
    ...
    3990:	3dc50513          	addi	a0,a0,988 # 6d68 <malloc+0x1c2c>
    3994:	6ee010ef          	jal	ra,5082 <printf>
  ...
  if(pid == 0){
    ...
    39dc:	3e050513          	addi	a0,a0,992 # 6db8 <malloc+0x1c7c>
    39e0:	6a2010ef          	jal	ra,5082 <printf>
    exit(1);
    39e4:	4505                	li	a0,1
    ...
    39f0:	3ac50513          	addi	a0,a0,940 # 6d98 <malloc+0x1c5c>
    39f4:	68e010ef          	jal	ra,5082 <printf>
    exit(1);
    39f8:	4505                	li	a0,1
    ...
    3a04:	10850513          	addi	a0,a0,264 # 5b08 <malloc+0x9cc>
    3a08:	67a010ef          	jal	ra,5082 <printf>
    exit(1);
    3a0c:	4505                	li	a0,1
...
0000000000003a42 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
    3a60:	854a                	mv	a0,s2
    3a62:	6da010ef          	jal	ra,513c <malloc>
    ...
    3a72:	6084                	ld	s1,0(s1)
      free(m1);
    3a74:	640010ef          	jal	ra,50b4 <free>
    while(m1){
    3a78:	fce5                	bnez	s1,3a70 <mem+0x2e>
    m1 = malloc(1024*20);
    3a7a:	6515                	lui	a0,0x5
    3a7c:	6c0010ef          	jal	ra,513c <malloc>
    if(m1 == 0){
    3a80:	c511                	beqz	a0,3a8c <mem+0x4a>
    free(m1);
    3a82:	632010ef          	jal	ra,50b4 <free>
    exit(0);
    3a86:	4501                	li	a0,0
    ...
    3a92:	35a50513          	addi	a0,a0,858 # 6de8 <malloc+0x1cac>
    3a96:	5ec010ef          	jal	ra,5082 <printf>
      exit(1);
    3a9a:	4505                	li	a0,1
...
0000000000003abc <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3ad8:	33450513          	addi	a0,a0,820 # 6e08 <malloc+0x1ccc>
    3adc:	1c8010ef          	jal	ra,4ca4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3ae0:	20200593          	li	a1,514
    3ae4:	00003517          	auipc	a0,0x3
    3ae8:	32450513          	addi	a0,a0,804 # 6e08 <malloc+0x1ccc>
  ...
  if(pid == 0) {
    ...
    3b3a:	2e250513          	addi	a0,a0,738 # 6e18 <malloc+0x1cdc>
    3b3e:	544010ef          	jal	ra,5082 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b4e:	2f650513          	addi	a0,a0,758 # 6e40 <malloc+0x1d04>
    3b52:	530010ef          	jal	ra,5082 <printf>
      exit(1);
    3b56:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3b7e:	28e50513          	addi	a0,a0,654 # 6e08 <malloc+0x1ccc>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3bb6:	2ae50513          	addi	a0,a0,686 # 6e60 <malloc+0x1d24>
    3bba:	4c8010ef          	jal	ra,5082 <printf>
    exit(1);
    3bbe:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3be6:	22650513          	addi	a0,a0,550 # 6e08 <malloc+0x1ccc>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c08:	28450513          	addi	a0,a0,644 # 6e88 <malloc+0x1d4c>
    3c0c:	476010ef          	jal	ra,5082 <printf>
    exit(1);
    3c10:	4505                	li	a0,1
...
0000000000003c1c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c40:	5e478793          	addi	a5,a5,1508 # 5220 <malloc+0xe4>
    3c44:	f6f43823          	sd	a5,-144(s0)
    3c48:	00001797          	auipc	a5,0x1
    3c4c:	5e078793          	addi	a5,a5,1504 # 5228 <malloc+0xec>
    3c50:	f6f43c23          	sd	a5,-136(s0)
    3c54:	00001797          	auipc	a5,0x1
    3c58:	5dc78793          	addi	a5,a5,1500 # 5230 <malloc+0xf4>
    3c5c:	f8f43023          	sd	a5,-128(s0)
    3c60:	00001797          	auipc	a5,0x1
    3c64:	5d878793          	addi	a5,a5,1496 # 5238 <malloc+0xfc>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3cd0:	e3c50513          	addi	a0,a0,-452 # 5b08 <malloc+0x9cc>
    3cd4:	3ae010ef          	jal	ra,5082 <printf>
      exit(1);
    3cd8:	4505                	li	a0,1
    ...
    3d32:	e7250513          	addi	a0,a0,-398 # 5ba0 <malloc+0xa64>
    3d36:	34c010ef          	jal	ra,5082 <printf>
        exit(1);
    3d3a:	4505                	li	a0,1
    3d3c:	719000ef          	jal	ra,4c54 <exit>
          printf("write failed %d\n", n);
    3d40:	00003517          	auipc	a0,0x3
    3d44:	16050513          	addi	a0,a0,352 # 6ea0 <malloc+0x1d64>
    3d48:	33a010ef          	jal	ra,5082 <printf>
          exit(1);
    3d4c:	4505                	li	a0,1
    ...
    3d5c:	16050513          	addi	a0,a0,352 # 6eb8 <malloc+0x1d7c>
    3d60:	322010ef          	jal	ra,5082 <printf>
          exit(1);
    3d64:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3dd4:	0f850513          	addi	a0,a0,248 # 6ec8 <malloc+0x1d8c>
    3dd8:	2aa010ef          	jal	ra,5082 <printf>
      exit(1);
    3ddc:	4505                	li	a0,1
...
0000000000003e00 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e2e:	0b6b8b93          	addi	s7,s7,182 # 6ee0 <malloc+0x1da4>
  for(i = 0; i < N; i++){
    ...
    3e68:	08450513          	addi	a0,a0,132 # 6ee8 <malloc+0x1dac>
    3e6c:	216010ef          	jal	ra,5082 <printf>
        exit(1);
    3e70:	4505                	li	a0,1
    ...
    3e7e:	06650513          	addi	a0,a0,102 # 6ee0 <malloc+0x1da4>
  ...
  fd = open(".", 0);
    ...
    3ea6:	abe50513          	addi	a0,a0,-1346 # 5960 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3ec8:	04450513          	addi	a0,a0,68 # 6f08 <malloc+0x1dcc>
    3ecc:	1b6010ef          	jal	ra,5082 <printf>
        exit(1);
    3ed0:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f2c:	00050513          	mv	a0,a0
    3f30:	152010ef          	jal	ra,5082 <printf>
        exit(1);
    3f34:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f58:	ffc50513          	addi	a0,a0,-4 # 6f50 <malloc+0x1e14>
    3f5c:	126010ef          	jal	ra,5082 <printf>
    exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f6c:	ba050513          	addi	a0,a0,-1120 # 5b08 <malloc+0x9cc>
    3f70:	112010ef          	jal	ra,5082 <printf>
      exit(1);
    3f74:	4505                	li	a0,1
...
00000000000040a2 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40ba:	ed250513          	addi	a0,a0,-302 # 6f88 <malloc+0x1e4c>
    40be:	3e7000ef          	jal	ra,4ca4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40c2:	20200593          	li	a1,514
    40c6:	00003517          	auipc	a0,0x3
    40ca:	ec250513          	addi	a0,a0,-318 # 6f88 <malloc+0x1e4c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    4116:	e7650513          	addi	a0,a0,-394 # 6f88 <malloc+0x1e4c>
  ...
  for(i = 0; ; i++){
    ...
    4172:	e2a50513          	addi	a0,a0,-470 # 6f98 <malloc+0x1e5c>
    4176:	70d000ef          	jal	ra,5082 <printf>
    exit(1);
    417a:	4505                	li	a0,1
    ...
    4186:	e3650513          	addi	a0,a0,-458 # 6fb8 <malloc+0x1e7c>
    418a:	6f9000ef          	jal	ra,5082 <printf>
      exit(1);
    418e:	4505                	li	a0,1
    ...
    419a:	e4250513          	addi	a0,a0,-446 # 6fd8 <malloc+0x1e9c>
    419e:	6e5000ef          	jal	ra,5082 <printf>
    exit(1);
    41a2:	4505                	li	a0,1
    ...
    41ae:	e4e50513          	addi	a0,a0,-434 # 6ff8 <malloc+0x1ebc>
    41b2:	6d1000ef          	jal	ra,5082 <printf>
      exit(1);
    41b6:	4505                	li	a0,1
    ...
    41c2:	e5a50513          	addi	a0,a0,-422 # 7018 <malloc+0x1edc>
    41c6:	6bd000ef          	jal	ra,5082 <printf>
      exit(1);
    41ca:	4505                	li	a0,1
    ...
    41d6:	e5e50513          	addi	a0,a0,-418 # 7030 <malloc+0x1ef4>
    41da:	6a9000ef          	jal	ra,5082 <printf>
      exit(1);
    41de:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    41f8:	d9450513          	addi	a0,a0,-620 # 6f88 <malloc+0x1e4c>
    ...
    4218:	e3c50513          	addi	a0,a0,-452 # 7050 <malloc+0x1f14>
    421c:	667000ef          	jal	ra,5082 <printf>
    exit(1);
    4220:	4505                	li	a0,1
...
0000000000004226 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    4236:	e3e50513          	addi	a0,a0,-450 # 7070 <malloc+0x1f34>
  ...
  fd = open("bigarg-ok", 0);
    ...
    425c:	e1850513          	addi	a0,a0,-488 # 7070 <malloc+0x1f34>
  ...
  close(fd);
    ...
    428e:	20678793          	addi	a5,a5,518 # 8490 <args.1821>
    4292:	00004697          	auipc	a3,0x4
    4296:	2f668693          	addi	a3,a3,758 # 8588 <args.1821+0xf8>
      args[i] = big;
    ...
    42de:	da650513          	addi	a0,a0,-602 # 7080 <malloc+0x1f44>
    42e2:	5a1000ef          	jal	ra,5082 <printf>
    exit(1);
    42e6:	4505                	li	a0,1
    ...
    42f6:	dae50513          	addi	a0,a0,-594 # 70a0 <malloc+0x1f64>
    42fa:	589000ef          	jal	ra,5082 <printf>
    exit(1);
    42fe:	4505                	li	a0,1
...
0000000000004304 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    434c:	d7850513          	addi	a0,a0,-648 # 70c0 <malloc+0x1f84>
    4350:	533000ef          	jal	ra,5082 <printf>
    exit(1);
    4354:	4505                	li	a0,1
    4356:	0ff000ef          	jal	ra,4c54 <exit>
      printf("failed to read value from memory\n");
    435a:	00003517          	auipc	a0,0x3
    435e:	d7e50513          	addi	a0,a0,-642 # 70d8 <malloc+0x1f9c>
    4362:	521000ef          	jal	ra,5082 <printf>
      exit(1);
    4366:	4505                	li	a0,1
...
000000000000436c <lazy_unmap>:
{
  ...
  exit(0);
    ...
    43cc:	cf850513          	addi	a0,a0,-776 # 70c0 <malloc+0x1f84>
    43d0:	4b3000ef          	jal	ra,5082 <printf>
    exit(1);
    43d4:	4505                	li	a0,1
    43d6:	07f000ef          	jal	ra,4c54 <exit>
      printf("error forking\n");
    43da:	00003517          	auipc	a0,0x3
    43de:	d2650513          	addi	a0,a0,-730 # 7100 <malloc+0x1fc4>
    43e2:	4a1000ef          	jal	ra,5082 <printf>
      exit(1);
    43e6:	4505                	li	a0,1
    ...
    4402:	d1250513          	addi	a0,a0,-750 # 7110 <malloc+0x1fd4>
    4406:	47d000ef          	jal	ra,5082 <printf>
        exit(1);
    440a:	4505                	li	a0,1
...
0000000000004410 <lazy_copy>:
{
    ...
    4458:	cd450513          	addi	a0,a0,-812 # 7128 <malloc+0x1fec>
    445c:	427000ef          	jal	ra,5082 <printf>
      exit(1);
    4460:	4505                	li	a0,1
    4462:	7f2000ef          	jal	ra,4c54 <exit>
  unsigned long bad[] = {
    4466:	00003797          	auipc	a5,0x3
    446a:	23a78793          	addi	a5,a5,570 # 76a0 <malloc+0x2564>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    449e:	fb6a0a13          	addi	s4,s4,-74 # 5450 <malloc+0x314>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44a2:	00001a97          	auipc	s5,0x1
    44a6:	ebea8a93          	addi	s5,s5,-322 # 5360 <malloc+0x224>
    int fd = open("README", 0);
    44aa:	4581                	li	a1,0
    44ac:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    4504:	c5850513          	addi	a0,a0,-936 # 7158 <malloc+0x201c>
    4508:	37b000ef          	jal	ra,5082 <printf>
    450c:	4505                	li	a0,1
    450e:	746000ef          	jal	ra,4c54 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4512:	00003517          	auipc	a0,0x3
    4516:	c5e50513          	addi	a0,a0,-930 # 7170 <malloc+0x2034>
    451a:	369000ef          	jal	ra,5082 <printf>
    451e:	4505                	li	a0,1
    4520:	734000ef          	jal	ra,4c54 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4524:	00003517          	auipc	a0,0x3
    4528:	c5c50513          	addi	a0,a0,-932 # 7180 <malloc+0x2044>
    452c:	357000ef          	jal	ra,5082 <printf>
    4530:	4505                	li	a0,1
    4532:	722000ef          	jal	ra,4c54 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4536:	00003517          	auipc	a0,0x3
    453a:	c6250513          	addi	a0,a0,-926 # 7198 <malloc+0x205c>
    453e:	345000ef          	jal	ra,5082 <printf>
    4542:	4505                	li	a0,1
...
0000000000004548 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    456a:	c4a50513          	addi	a0,a0,-950 # 71b0 <malloc+0x2074>
    456e:	315000ef          	jal	ra,5082 <printf>
  for(nfiles = 0; ; nfiles++){
    4572:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4586:	c3ec8c93          	addi	s9,s9,-962 # 71c0 <malloc+0x2084>
    int total = 0;
    458a:	4d81                	li	s11,0
    ...
    45d8:	8566                	mv	a0,s9
    45da:	2a9000ef          	jal	ra,5082 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    45f8:	bdc50513          	addi	a0,a0,-1060 # 71d0 <malloc+0x2094>
    45fc:	287000ef          	jal	ra,5082 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4666:	b8e50513          	addi	a0,a0,-1138 # 71f0 <malloc+0x20b4>
    466a:	219000ef          	jal	ra,5082 <printf>
}
    ...
    46ae:	b3650513          	addi	a0,a0,-1226 # 71e0 <malloc+0x20a4>
    46b2:	1d1000ef          	jal	ra,5082 <printf>
    close(fd);
    46b6:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    46d8:	b3450513          	addi	a0,a0,-1228 # 7208 <malloc+0x20cc>
    46dc:	1a7000ef          	jal	ra,5082 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    46fc:	b3850513          	addi	a0,a0,-1224 # 7230 <malloc+0x20f4>
    4700:	183000ef          	jal	ra,5082 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    471c:	b0050513          	addi	a0,a0,-1280 # 7218 <malloc+0x20dc>
    4720:	163000ef          	jal	ra,5082 <printf>
    exit(1);
    4724:	4505                	li	a0,1
    ...
    4738:	b0450513          	addi	a0,a0,-1276 # 7238 <malloc+0x20fc>
    473c:	147000ef          	jal	ra,5082 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    478a:	aba50513          	addi	a0,a0,-1350 # 7240 <malloc+0x2104>
    478e:	0f5000ef          	jal	ra,5082 <printf>
          return -1;
    4792:	59fd                	li	s3,-1
        }
      }
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    481a:	a42b8b93          	addi	s7,s7,-1470 # 7258 <malloc+0x211c>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    482c:	a68d0d13          	addi	s10,s10,-1432 # 7290 <malloc+0x2154>
    ...
    483c:	a38d8d93          	addi	s11,s11,-1480 # 7270 <malloc+0x2134>
    ...
    4848:	a881                	j	4898 <drivetests+0xa6>
        printf("usertests slow tests starting\n");
    484a:	856e                	mv	a0,s11
    484c:	037000ef          	jal	ra,5082 <printf>
    ...
    4860:	85aa                	mv	a1,a0
    4862:	856a                	mv	a0,s10
    4864:	01f000ef          	jal	ra,5082 <printf>
      if(continuous != 2) {
    ...
    printf("usertests starting\n");
    487c:	855e                	mv	a0,s7
    487e:	005000ef          	jal	ra,5082 <printf>
    int free0 = countfree();
    ...
    48b4:	85aa                	mv	a1,a0
    48b6:	856a                	mv	a0,s10
    48b8:	7ca000ef          	jal	ra,5082 <printf>
      if(continuous != 2) {
    ...
    48ca:	9fa50513          	addi	a0,a0,-1542 # 72c0 <malloc+0x2184>
    48ce:	7b4000ef          	jal	ra,5082 <printf>
      return 1;
    48d2:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  int continuous = 0;
    ...
    4982:	96250513          	addi	a0,a0,-1694 # 72e0 <malloc+0x21a4>
    4986:	6fc000ef          	jal	ra,5082 <printf>
    exit(1);
    498a:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    49a6:	96e50513          	addi	a0,a0,-1682 # 7310 <malloc+0x21d4>
    49aa:	6d8000ef          	jal	ra,5082 <printf>
  exit(0);
    49ae:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4cfc:	1101                	addi	sp,sp,-32
    4cfe:	ec06                	sd	ra,24(sp)
    4d00:	e822                	sd	s0,16(sp)
    4d02:	1000                	addi	s0,sp,32
    4d04:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4d08:	4605                	li	a2,1
    4d0a:	fef40593          	addi	a1,s0,-17
    4d0e:	f67ff0ef          	jal	ra,4c74 <write>
}
    4d12:	60e2                	ld	ra,24(sp)
    4d14:	6442                	ld	s0,16(sp)
    4d16:	6105                	addi	sp,sp,32
    4d18:	8082                	ret

0000000000004d1a <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4d1a:	715d                	addi	sp,sp,-80
    4d1c:	e486                	sd	ra,72(sp)
    4d1e:	e0a2                	sd	s0,64(sp)
    4d20:	fc26                	sd	s1,56(sp)
    4d22:	f84a                	sd	s2,48(sp)
    4d24:	f44e                	sd	s3,40(sp)
    4d26:	0880                	addi	s0,sp,80
    4d28:	84aa                	mv	s1,a0
  char buf[20];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4d2a:	c299                	beqz	a3,4d30 <printint+0x16>
    4d2c:	0805c663          	bltz	a1,4db8 <printint+0x9e>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4d30:	2581                	sext.w	a1,a1
  neg = 0;
    4d32:	4881                	li	a7,0
    4d34:	fb840693          	addi	a3,s0,-72
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4d3a:	2601                	sext.w	a2,a2
    4d3c:	00003517          	auipc	a0,0x3
    4d40:	a1450513          	addi	a0,a0,-1516 # 7750 <digits>
    4d44:	883a                	mv	a6,a4
    4d46:	2705                	addiw	a4,a4,1
    4d48:	02c5f7bb          	remuw	a5,a1,a2
    4d4c:	1782                	slli	a5,a5,0x20
    4d4e:	9381                	srli	a5,a5,0x20
    4d50:	97aa                	add	a5,a5,a0
    4d52:	0007c783          	lbu	a5,0(a5)
    4d56:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4d5a:	0005879b          	sext.w	a5,a1
    4d5e:	02c5d5bb          	divuw	a1,a1,a2
    4d62:	0685                	addi	a3,a3,1
    4d64:	fec7f0e3          	bgeu	a5,a2,4d44 <printint+0x2a>
  if(neg)
    4d68:	00088b63          	beqz	a7,4d7e <printint+0x64>
    buf[i++] = '-';
    4d6c:	fd040793          	addi	a5,s0,-48
    4d70:	973e                	add	a4,a4,a5
    4d72:	02d00793          	li	a5,45
    4d76:	fef70423          	sb	a5,-24(a4)
    4d7a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4d7e:	02e05663          	blez	a4,4daa <printint+0x90>
    4d82:	fb840793          	addi	a5,s0,-72
    4d86:	00e78933          	add	s2,a5,a4
    4d8a:	fff78993          	addi	s3,a5,-1
    4d8e:	99ba                	add	s3,s3,a4
    4d90:	377d                	addiw	a4,a4,-1
    4d92:	1702                	slli	a4,a4,0x20
    4d94:	9301                	srli	a4,a4,0x20
    4d96:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4d9a:	fff94583          	lbu	a1,-1(s2)
    4d9e:	8526                	mv	a0,s1
    4da0:	f5dff0ef          	jal	ra,4cfc <putc>
  while(--i >= 0)
    4da4:	197d                	addi	s2,s2,-1
    4da6:	ff391ae3          	bne	s2,s3,4d9a <printint+0x80>
}
    4daa:	60a6                	ld	ra,72(sp)
    4dac:	6406                	ld	s0,64(sp)
    4dae:	74e2                	ld	s1,56(sp)
    4db0:	7942                	ld	s2,48(sp)
    4db2:	79a2                	ld	s3,40(sp)
    4db4:	6161                	addi	sp,sp,80
    4db6:	8082                	ret
    x = -xx;
    4db8:	40b005bb          	negw	a1,a1
    neg = 1;
    4dbc:	4885                	li	a7,1
    x = -xx;
    4dbe:	bf9d                	j	4d34 <printint+0x1a>

0000000000004dc0 <vprintf>:
}
...
{
    4dc0:	7119                	addi	sp,sp,-128
    4dc2:	fc86                	sd	ra,120(sp)
    4dc4:	f8a2                	sd	s0,112(sp)
    4dc6:	f4a6                	sd	s1,104(sp)
    4dc8:	f0ca                	sd	s2,96(sp)
    4dca:	ecce                	sd	s3,88(sp)
    4dcc:	e8d2                	sd	s4,80(sp)
    4dce:	e4d6                	sd	s5,72(sp)
    4dd0:	e0da                	sd	s6,64(sp)
    4dd2:	fc5e                	sd	s7,56(sp)
    4dd4:	f862                	sd	s8,48(sp)
    4dd6:	f466                	sd	s9,40(sp)
    4dd8:	f06a                	sd	s10,32(sp)
    4dda:	ec6e                	sd	s11,24(sp)
    4ddc:	0100                	addi	s0,sp,128
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4dde:	0005c903          	lbu	s2,0(a1)
    4de2:	24090c63          	beqz	s2,503a <vprintf+0x27a>
    4de6:	8b2a                	mv	s6,a0
    4de8:	8a2e                	mv	s4,a1
    4dea:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4df2:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4df6:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4dfa:	06c00d13          	li	s10,108
    ...
    4dfe:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4e02:	00003c97          	auipc	s9,0x3
    4e06:	94ec8c93          	addi	s9,s9,-1714 # 7750 <digits>
    4e0a:	a005                	j	4e2a <vprintf+0x6a>
        putc(fd, c0);
    4e0c:	85ca                	mv	a1,s2
    4e0e:	855a                	mv	a0,s6
    4e10:	eedff0ef          	jal	ra,4cfc <putc>
    4e14:	a019                	j	4e1a <vprintf+0x5a>
    } else if(state == '%'){
    4e16:	03598263          	beq	s3,s5,4e3a <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    4e1a:	2485                	addiw	s1,s1,1
    4e1c:	8726                	mv	a4,s1
    4e1e:	009a07b3          	add	a5,s4,s1
    4e22:	0007c903          	lbu	s2,0(a5)
    4e26:	20090a63          	beqz	s2,503a <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
    4e2a:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4e2e:	fe0994e3          	bnez	s3,4e16 <vprintf+0x56>
      if(c0 == '%'){
    4e32:	fd579de3          	bne	a5,s5,4e0c <vprintf+0x4c>
        state = '%';
    4e36:	89be                	mv	s3,a5
    4e38:	b7cd                	j	4e1a <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4e3a:	c3c1                	beqz	a5,4eba <vprintf+0xfa>
    4e3c:	00ea06b3          	add	a3,s4,a4
    4e40:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4e44:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4e46:	c681                	beqz	a3,4e4e <vprintf+0x8e>
    4e48:	9752                	add	a4,a4,s4
    4e4a:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4e4e:	03878e63          	beq	a5,s8,4e8a <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
    4e52:	05a78863          	beq	a5,s10,4ea2 <vprintf+0xe2>
      } else if(c0 == 'u'){
    4e56:	0db78b63          	beq	a5,s11,4f2c <vprintf+0x16c>
    ...
    4e5a:	07800713          	li	a4,120
    4e5e:	10e78d63          	beq	a5,a4,4f78 <vprintf+0x1b8>
    ...
    4e62:	07000713          	li	a4,112
    4e66:	14e78263          	beq	a5,a4,4faa <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4e6a:	06300713          	li	a4,99
    4e6e:	16e78f63          	beq	a5,a4,4fec <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4e72:	07300713          	li	a4,115
    4e76:	18e78563          	beq	a5,a4,5000 <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4e7a:	05579063          	bne	a5,s5,4eba <vprintf+0xfa>
        putc(fd, '%');
    4e7e:	85d6                	mv	a1,s5
    4e80:	855a                	mv	a0,s6
    4e82:	e7bff0ef          	jal	ra,4cfc <putc>
      ...
      state = 0;
    4e86:	4981                	li	s3,0
    4e88:	bf49                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, int), 10, 1);
    4e8a:	008b8913          	addi	s2,s7,8
    4e8e:	4685                	li	a3,1
    4e90:	4629                	li	a2,10
    4e92:	000ba583          	lw	a1,0(s7)
    4e96:	855a                	mv	a0,s6
    4e98:	e83ff0ef          	jal	ra,4d1a <printint>
    4e9c:	8bca                	mv	s7,s2
      state = 0;
    4e9e:	4981                	li	s3,0
    4ea0:	bfad                	j	4e1a <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
    4ea2:	03868663          	beq	a3,s8,4ece <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4ea6:	05a68163          	beq	a3,s10,4ee8 <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
    4eaa:	09b68d63          	beq	a3,s11,4f44 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4eae:	03a68f63          	beq	a3,s10,4eec <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
    4eb2:	07800793          	li	a5,120
    4eb6:	0cf68d63          	beq	a3,a5,4f90 <vprintf+0x1d0>
        putc(fd, '%');
    4eba:	85d6                	mv	a1,s5
    4ebc:	855a                	mv	a0,s6
    4ebe:	e3fff0ef          	jal	ra,4cfc <putc>
        putc(fd, c0);
    4ec2:	85ca                	mv	a1,s2
    4ec4:	855a                	mv	a0,s6
    4ec6:	e37ff0ef          	jal	ra,4cfc <putc>
      state = 0;
    4eca:	4981                	li	s3,0
    4ecc:	b7b9                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4ece:	008b8913          	addi	s2,s7,8
    4ed2:	4685                	li	a3,1
    4ed4:	4629                	li	a2,10
    4ed6:	000bb583          	ld	a1,0(s7)
    4eda:	855a                	mv	a0,s6
    4edc:	e3fff0ef          	jal	ra,4d1a <printint>
        i += 1;
    4ee0:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4ee2:	8bca                	mv	s7,s2
      state = 0;
    4ee4:	4981                	li	s3,0
        i += 1;
    4ee6:	bf15                	j	4e1a <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4ee8:	03860563          	beq	a2,s8,4f12 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4eec:	07b60963          	beq	a2,s11,4f5e <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4ef0:	07800793          	li	a5,120
    4ef4:	fcf613e3          	bne	a2,a5,4eba <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4ef8:	008b8913          	addi	s2,s7,8
    4efc:	4681                	li	a3,0
    4efe:	4641                	li	a2,16
    4f00:	000bb583          	ld	a1,0(s7)
    4f04:	855a                	mv	a0,s6
    4f06:	e15ff0ef          	jal	ra,4d1a <printint>
        i += 2;
    4f0a:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4f0c:	8bca                	mv	s7,s2
      state = 0;
    4f0e:	4981                	li	s3,0
        i += 2;
    4f10:	b729                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f12:	008b8913          	addi	s2,s7,8
    4f16:	4685                	li	a3,1
    4f18:	4629                	li	a2,10
    4f1a:	000bb583          	ld	a1,0(s7)
    4f1e:	855a                	mv	a0,s6
    4f20:	dfbff0ef          	jal	ra,4d1a <printint>
        i += 2;
    4f24:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f26:	8bca                	mv	s7,s2
      state = 0;
    4f28:	4981                	li	s3,0
        i += 2;
    4f2a:	bdc5                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    4f2c:	008b8913          	addi	s2,s7,8
    4f30:	4681                	li	a3,0
    4f32:	4629                	li	a2,10
    4f34:	000be583          	lwu	a1,0(s7)
    4f38:	855a                	mv	a0,s6
    4f3a:	de1ff0ef          	jal	ra,4d1a <printint>
    4f3e:	8bca                	mv	s7,s2
      state = 0;
    4f40:	4981                	li	s3,0
    4f42:	bde1                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4f44:	008b8913          	addi	s2,s7,8
    4f48:	4681                	li	a3,0
    4f4a:	4629                	li	a2,10
    4f4c:	000bb583          	ld	a1,0(s7)
    4f50:	855a                	mv	a0,s6
    4f52:	dc9ff0ef          	jal	ra,4d1a <printint>
        i += 1;
    ...
    4f5a:	4981                	li	s3,0
        i += 1;
    4f5c:	bd7d                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4f5e:	008b8913          	addi	s2,s7,8
    4f62:	4681                	li	a3,0
    4f64:	4629                	li	a2,10
    4f66:	000bb583          	ld	a1,0(s7)
    4f6a:	855a                	mv	a0,s6
    4f6c:	dafff0ef          	jal	ra,4d1a <printint>
        i += 2;
    4f70:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4f72:	8bca                	mv	s7,s2
      state = 0;
    4f74:	4981                	li	s3,0
        i += 2;
    4f76:	b555                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    4f78:	008b8913          	addi	s2,s7,8
    4f7c:	4681                	li	a3,0
    4f7e:	4641                	li	a2,16
    4f80:	000be583          	lwu	a1,0(s7)
    4f84:	855a                	mv	a0,s6
    4f86:	d95ff0ef          	jal	ra,4d1a <printint>
    4f8a:	8bca                	mv	s7,s2
      state = 0;
    4f8c:	4981                	li	s3,0
    4f8e:	b571                	j	4e1a <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4f90:	008b8913          	addi	s2,s7,8
    4f94:	4681                	li	a3,0
    4f96:	4641                	li	a2,16
    4f98:	000bb583          	ld	a1,0(s7)
    4f9c:	855a                	mv	a0,s6
    4f9e:	d7dff0ef          	jal	ra,4d1a <printint>
        i += 1;
    4fa2:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    4fa4:	8bca                	mv	s7,s2
      state = 0;
    4fa6:	4981                	li	s3,0
        i += 1;
    4fa8:	bd8d                	j	4e1a <vprintf+0x5a>
        printptr(fd, va_arg(ap, uint64));
    4faa:	008b8793          	addi	a5,s7,8
    4fae:	f8f43423          	sd	a5,-120(s0)
    4fb2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4fb6:	03000593          	li	a1,48
    4fba:	855a                	mv	a0,s6
    4fbc:	d41ff0ef          	jal	ra,4cfc <putc>
  putc(fd, 'x');
    4fc0:	07800593          	li	a1,120
    4fc4:	855a                	mv	a0,s6
    4fc6:	d37ff0ef          	jal	ra,4cfc <putc>
    4fca:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4fcc:	03c9d793          	srli	a5,s3,0x3c
    4fd0:	97e6                	add	a5,a5,s9
    4fd2:	0007c583          	lbu	a1,0(a5)
    4fd6:	855a                	mv	a0,s6
    4fd8:	d25ff0ef          	jal	ra,4cfc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4fdc:	0992                	slli	s3,s3,0x4
    4fde:	397d                	addiw	s2,s2,-1
    4fe0:	fe0916e3          	bnez	s2,4fcc <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
    4fe4:	f8843b83          	ld	s7,-120(s0)
      state = 0;
    4fe8:	4981                	li	s3,0
    4fea:	bd05                	j	4e1a <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
    4fec:	008b8913          	addi	s2,s7,8
    4ff0:	000bc583          	lbu	a1,0(s7)
    4ff4:	855a                	mv	a0,s6
    4ff6:	d07ff0ef          	jal	ra,4cfc <putc>
    4ffa:	8bca                	mv	s7,s2
      state = 0;
    4ffc:	4981                	li	s3,0
    4ffe:	bd31                	j	4e1a <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
    5000:	008b8993          	addi	s3,s7,8
    5004:	000bb903          	ld	s2,0(s7)
    5008:	00090f63          	beqz	s2,5026 <vprintf+0x266>
        for(; *s; s++)
    500c:	00094583          	lbu	a1,0(s2)
    5010:	c195                	beqz	a1,5034 <vprintf+0x274>
          putc(fd, *s);
    5012:	855a                	mv	a0,s6
    5014:	ce9ff0ef          	jal	ra,4cfc <putc>
        for(; *s; s++)
    5018:	0905                	addi	s2,s2,1
    501a:	00094583          	lbu	a1,0(s2)
    501e:	f9f5                	bnez	a1,5012 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
    5020:	8bce                	mv	s7,s3
      state = 0;
    5022:	4981                	li	s3,0
    5024:	bbdd                	j	4e1a <vprintf+0x5a>
          s = "(null)";
    5026:	00002917          	auipc	s2,0x2
    502a:	72290913          	addi	s2,s2,1826 # 7748 <malloc+0x260c>
        for(; *s; s++)
    502e:	02800593          	li	a1,40
    5032:	b7c5                	j	5012 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
    5034:	8bce                	mv	s7,s3
      state = 0;
    5036:	4981                	li	s3,0
    5038:	b3cd                	j	4e1a <vprintf+0x5a>
    }
  }
}
    503a:	70e6                	ld	ra,120(sp)
    503c:	7446                	ld	s0,112(sp)
    503e:	74a6                	ld	s1,104(sp)
    5040:	7906                	ld	s2,96(sp)
    5042:	69e6                	ld	s3,88(sp)
    5044:	6a46                	ld	s4,80(sp)
    5046:	6aa6                	ld	s5,72(sp)
    5048:	6b06                	ld	s6,64(sp)
    504a:	7be2                	ld	s7,56(sp)
    504c:	7c42                	ld	s8,48(sp)
    504e:	7ca2                	ld	s9,40(sp)
    5050:	7d02                	ld	s10,32(sp)
    5052:	6de2                	ld	s11,24(sp)
    5054:	6109                	addi	sp,sp,128
    5056:	8082                	ret

0000000000005058 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5058:	715d                	addi	sp,sp,-80
    505a:	ec06                	sd	ra,24(sp)
    505c:	e822                	sd	s0,16(sp)
    505e:	1000                	addi	s0,sp,32
    5060:	e010                	sd	a2,0(s0)
    5062:	e414                	sd	a3,8(s0)
    5064:	e818                	sd	a4,16(s0)
    5066:	ec1c                	sd	a5,24(s0)
    5068:	03043023          	sd	a6,32(s0)
    506c:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5070:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5074:	8622                	mv	a2,s0
    5076:	d4bff0ef          	jal	ra,4dc0 <vprintf>
}
    507a:	60e2                	ld	ra,24(sp)
    507c:	6442                	ld	s0,16(sp)
    507e:	6161                	addi	sp,sp,80
    5080:	8082                	ret

0000000000005082 <printf>:

void
printf(const char *fmt, ...)
{
    5082:	711d                	addi	sp,sp,-96
    5084:	ec06                	sd	ra,24(sp)
    5086:	e822                	sd	s0,16(sp)
    5088:	1000                	addi	s0,sp,32
    508a:	e40c                	sd	a1,8(s0)
    508c:	e810                	sd	a2,16(s0)
    508e:	ec14                	sd	a3,24(s0)
    5090:	f018                	sd	a4,32(s0)
    5092:	f41c                	sd	a5,40(s0)
    5094:	03043823          	sd	a6,48(s0)
    5098:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    509c:	00840613          	addi	a2,s0,8
    50a0:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    50a4:	85aa                	mv	a1,a0
    50a6:	4505                	li	a0,1
    50a8:	d19ff0ef          	jal	ra,4dc0 <vprintf>
}
    50ac:	60e2                	ld	ra,24(sp)
    50ae:	6442                	ld	s0,16(sp)
    50b0:	6125                	addi	sp,sp,96
    50b2:	8082                	ret

00000000000050b4 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    50b4:	1141                	addi	sp,sp,-16
    50b6:	e422                	sd	s0,8(sp)
    50b8:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    50ba:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    50be:	00003797          	auipc	a5,0x3
    50c2:	3c27b783          	ld	a5,962(a5) # 8480 <freep>
    50c6:	a805                	j	50f6 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    50c8:	4618                	lw	a4,8(a2)
    50ca:	9db9                	addw	a1,a1,a4
    50cc:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    50d0:	6398                	ld	a4,0(a5)
    50d2:	6318                	ld	a4,0(a4)
    50d4:	fee53823          	sd	a4,-16(a0)
    50d8:	a091                	j	511c <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    50da:	ff852703          	lw	a4,-8(a0)
    50de:	9e39                	addw	a2,a2,a4
    50e0:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    50e2:	ff053703          	ld	a4,-16(a0)
    50e6:	e398                	sd	a4,0(a5)
    50e8:	a099                	j	512e <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    50ea:	6398                	ld	a4,0(a5)
    50ec:	00e7e463          	bltu	a5,a4,50f4 <free+0x40>
    50f0:	00e6ea63          	bltu	a3,a4,5104 <free+0x50>
{
    50f4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    50f6:	fed7fae3          	bgeu	a5,a3,50ea <free+0x36>
    50fa:	6398                	ld	a4,0(a5)
    50fc:	00e6e463          	bltu	a3,a4,5104 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5100:	fee7eae3          	bltu	a5,a4,50f4 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5104:	ff852583          	lw	a1,-8(a0)
    5108:	6390                	ld	a2,0(a5)
    510a:	02059713          	slli	a4,a1,0x20
    510e:	9301                	srli	a4,a4,0x20
    5110:	0712                	slli	a4,a4,0x4
    5112:	9736                	add	a4,a4,a3
    5114:	fae60ae3          	beq	a2,a4,50c8 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5118:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    511c:	4790                	lw	a2,8(a5)
    511e:	02061713          	slli	a4,a2,0x20
    5122:	9301                	srli	a4,a4,0x20
    5124:	0712                	slli	a4,a4,0x4
    5126:	973e                	add	a4,a4,a5
    5128:	fae689e3          	beq	a3,a4,50da <free+0x26>
  } else
    p->s.ptr = bp;
    512c:	e394                	sd	a3,0(a5)
  freep = p;
    512e:	00003717          	auipc	a4,0x3
    5132:	34f73923          	sd	a5,850(a4) # 8480 <freep>
}
    5136:	6422                	ld	s0,8(sp)
    5138:	0141                	addi	sp,sp,16
    513a:	8082                	ret

000000000000513c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    513c:	7139                	addi	sp,sp,-64
    513e:	fc06                	sd	ra,56(sp)
    5140:	f822                	sd	s0,48(sp)
    5142:	f426                	sd	s1,40(sp)
    5144:	f04a                	sd	s2,32(sp)
    5146:	ec4e                	sd	s3,24(sp)
    5148:	e852                	sd	s4,16(sp)
    514a:	e456                	sd	s5,8(sp)
    514c:	e05a                	sd	s6,0(sp)
    514e:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5150:	02051493          	slli	s1,a0,0x20
    5154:	9081                	srli	s1,s1,0x20
    5156:	04bd                	addi	s1,s1,15
    5158:	8091                	srli	s1,s1,0x4
    515a:	0014899b          	addiw	s3,s1,1
    515e:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5160:	00003517          	auipc	a0,0x3
    5164:	32053503          	ld	a0,800(a0) # 8480 <freep>
    5168:	c515                	beqz	a0,5194 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    516a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    516c:	4798                	lw	a4,8(a5)
    516e:	02977f63          	bgeu	a4,s1,51ac <malloc+0x70>
    5172:	8a4e                	mv	s4,s3
    5174:	0009871b          	sext.w	a4,s3
    5178:	6685                	lui	a3,0x1
    517a:	00d77363          	bgeu	a4,a3,5180 <malloc+0x44>
    517e:	6a05                	lui	s4,0x1
    5180:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5184:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5188:	00003917          	auipc	s2,0x3
    518c:	2f890913          	addi	s2,s2,760 # 8480 <freep>
  if(p == SBRK_ERROR)
    5190:	5afd                	li	s5,-1
    5192:	a0bd                	j	5200 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
    5194:	0000a797          	auipc	a5,0xa
    5198:	b1478793          	addi	a5,a5,-1260 # eca8 <base>
    519c:	00003717          	auipc	a4,0x3
    51a0:	2ef73223          	sd	a5,740(a4) # 8480 <freep>
    51a4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    51a6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    51aa:	b7e1                	j	5172 <malloc+0x36>
      if(p->s.size == nunits)
    51ac:	02e48b63          	beq	s1,a4,51e2 <malloc+0xa6>
        p->s.size -= nunits;
    51b0:	4137073b          	subw	a4,a4,s3
    51b4:	c798                	sw	a4,8(a5)
        p += p->s.size;
    51b6:	1702                	slli	a4,a4,0x20
    51b8:	9301                	srli	a4,a4,0x20
    51ba:	0712                	slli	a4,a4,0x4
    51bc:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    51be:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    51c2:	00003717          	auipc	a4,0x3
    51c6:	2aa73f23          	sd	a0,702(a4) # 8480 <freep>
      return (void*)(p + 1);
    51ca:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    51ce:	70e2                	ld	ra,56(sp)
    51d0:	7442                	ld	s0,48(sp)
    51d2:	74a2                	ld	s1,40(sp)
    51d4:	7902                	ld	s2,32(sp)
    51d6:	69e2                	ld	s3,24(sp)
    51d8:	6a42                	ld	s4,16(sp)
    51da:	6aa2                	ld	s5,8(sp)
    51dc:	6b02                	ld	s6,0(sp)
    51de:	6121                	addi	sp,sp,64
    51e0:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    51e2:	6398                	ld	a4,0(a5)
    51e4:	e118                	sd	a4,0(a0)
    51e6:	bff1                	j	51c2 <malloc+0x86>
  hp->s.size = nu;
    51e8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    51ec:	0541                	addi	a0,a0,16
    51ee:	ec7ff0ef          	jal	ra,50b4 <free>
  return freep;
    51f2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    51f6:	dd61                	beqz	a0,51ce <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    51f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    51fa:	4798                	lw	a4,8(a5)
    51fc:	fa9778e3          	bgeu	a4,s1,51ac <malloc+0x70>
    if(p == freep)
    5200:	00093703          	ld	a4,0(s2)
    5204:	853e                	mv	a0,a5
    5206:	fef719e3          	bne	a4,a5,51f8 <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
    520a:	8552                	mv	a0,s4
    520c:	a15ff0ef          	jal	ra,4c20 <sbrk>
  if(p == SBRK_ERROR)
    5210:	fd551ce3          	bne	a0,s5,51e8 <malloc+0xac>
        return 0;
    5214:	4501                	li	a0,0
    5216:	bf65                	j	51ce <malloc+0x92>
